...
export default {
  ...
  data: () => ({
    ...
    urlItemsDetailsFunctional_exploration: "",
    urlProducts: "",
    urlDeleteItems: "",
    sortBy: "id",
    sortByProd: "id",
    ...
    loadingDetailsFunctional_exploration: {
      list: false,
      refresh: false,
      filter: false,
    },
  ...
  methods: {
    ...
    getItemsEvents() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsAll + "?type_planning=RDV",
            params: params,
          })
          .then((response) => {
            this.events = [];
    ...
    getItemsEventsSurgical() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsAll + "?type_planning=SURGICAL_INTERVENTIONS",
            params: params,
          })
          .then((response) => {
            this.events = [];
    ...
    getItemsDetailsFunctional_exploration() {
      ...
      return new Promise((resolve, reject) => {
        this.loadingDetailsFunctional_exploration.list = true;
        //console.log("ls params", params);
        //console.log("Sorts", sortBy, sortDesc);
        self.$store
          .dispatch("request", {
            url:
              self.urlItemsDetailsFunctional_exploration +
              "?details_consultation=" +
              this.form.consult,
            params: params,
          })
          ...
          .then(() => {
            self.loadingDetailsFunctional_exploration.list = false;
            resolve();
          });
      });
    },
    ...
    deleteItemFunctional_exploration(item) {
      let self = this;
      this.loadingDetailsFunctional_exploration.refresh = true;
      this.$store
        .dispatch("request", {
          url: self.urlItemsDetailsFunctional_exploration + "/" + item.id,
          method: "DELETE",
        })
        .then(() => {
          // console.log("delete", this.urlItems);
        ...
        .then(() => {
          self.loadingDetailsFunctional_exploration.refresh = false;
          // self.dialog.show = false;
        });
    },
