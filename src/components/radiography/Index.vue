  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_radiography')"
          >
...
export default {
  ...
  methods: {
    upload() {
      ...
      axios
        .post("radiographs/upload", formData, {
          headers: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.radiography.new.title",
        submit: "$vuetify.radiography.new.submit",
        success: "$vuetify.radiography.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editRadiography(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.radiography.update.title",
        submit: "$vuetify.radiography.update.submit",
        success: "$vuetify.radiography.update.success",
      };
