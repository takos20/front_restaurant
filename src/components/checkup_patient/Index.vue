  ...
  <div>
    <v-card class="pb-4" height="60">
      <div class="mt-5 mx-5">
        ...
        <!--            dark-->
        <!--            v-if="-->
        <!--              _.includes(this.$auth.user().permissions, 'add_checkuppatient')-->
        <!--            "-->
        <!--          >-->
    ...
    <v-card>
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.checkup.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
          ...
          <v-hover>
            <tbody slot-scope="{ hover }">
              <tr :key="item.id" v-for="item in items">
                ...
                <td class="subtitle-2">
                  {{ item.checkup ? item.checkup.title : "-" }}
                </td>
                <!--                <td class="subtitle-2">-->
                <!--                  {{-->
                <!--                    item.results-->
                      ...
                      <template
                        ...
                        v-if="
                          _.includes(
                            ...
                            'change_checkuppatient'
                          )
                        "
                      >
                        <v-btn
                          @click="editCheckupPatient(item)"
                          color="secondary"
                          icon
                          text
                          v-on="on"
...
import FormCheckup from "./Formbills";
...
export default {
  ...
  data: () => ({
    ...
    messagesDelete: {
      success: "$vuetify.checkupPatient.delete.success",
    },
  }),
  ...
  methods: {
    editCertificate(item) {
      ...
      this.messages = {
        title: "$vuetify.checkupPatient.update.title",
        submit: "$vuetify.checkupPatient.update.submit",
        success: "$vuetify.checkupPatient.update.success",
      };
      this.$refs.checkupPatientForm.setForm(item);
    ...
    create() {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.checkupPatient.new.title",
        submit: "$vuetify.checkupPatient.new.submit",
        success: "$vuetify.checkupPatient.new.success",
      };
    },
    editCheckupPatient(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.checkup.update.title",
        submit: "$vuetify.checkup.update.submit",
        success: "$vuetify.checkup.update.success",
      };
      this.$refs.checkupPatientForm.setForm(item);
    },
    showFilter() {
