  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_diagnostic')"
          >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.diagnostic.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
          ...
          <v-hover>
            <tbody slot-scope="{ hover }">
              ...
              <tr :key="item.id" v-for="item in items">
                ...
                <td class="subtitle-2">
                  {{ item.type_diagnostic ? item.type_diagnostic.title : "" }}
                </td>
                <td class="subtitle-2">
...
export default {
  ...
  methods: {
    upload() {
      ...
      axios
        .post("diagnostics/upload", formData, {
          headers: {
    ...
    setHeaders() {
      this.headers = [
        ...
        {
          text: "$vuetify.type_diagnostic.title",
          value: "type_examen",
          align: "start",
          sortable: true,
          width: "50",
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.diagnostic.new.title",
        submit: "$vuetify.diagnostic.new.submit",
        success: "$vuetify.diagnostic.new.success",
      };
      this.form = {
        id: null,
        title: null,
