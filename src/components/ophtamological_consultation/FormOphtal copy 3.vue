        ...
        <v-form @submit.prevent="saveAll">
          <v-stepper-items>
            <v-stepper-content step="1">
              ...
              <v-card max-width="1520px" class="mt-5">
                <div
                ...
                <v-container class="mt-3" fluid>
                  ...
                  <v-card-text>
                    <v-card-text
                      ...
                      :key="index"
                      style="height: 255px; width: 1200px"
                    >
                      <v-divider></v-divider>
                              ...
                              <v-col cols="12" sm="1" class="my-4">
                                <v-tooltip top>
                                  <template v-slot:activator="{ on }">
                                    <v-icon
                                      @click="
                                        refreshItemsFunctional_exploration()
                                      "
                                      v-on="on"
                                    >
                                      mdi-refresh
          ...
          {{ $vuetify.lang.t("$vuetify.btn.refresh") }}
              ...
              <td class="subtitle-2">{{ item.conclusion }}</td> -->
                          ...
                          <delete-item
                            ...
                            @getItemsDetails="
                              getItemsDetailsFunctional_exploration
                            "
                          ></delete-item>
                        </v-card-text>
                      </v-card>
                ...
                <td class="subtitle-2">{{ item.conclusion }}</td> -->
                    ...
                    <br />
                    <div
                      class="title mb-5 white--texttext-center"
                      style="height: 30px; margin-top: 30px"
                    >
                      {{
                        $vuetify.lang.t(
                      ...
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            ...
                            type="number"
                            v-model="
                              form.refraction_vd_spherical_left_right_eye_two
                            "
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                      ...
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            ...
                            type="number"
                            v-model="
                              form.refraction_vd_cylinder_left_right_eye_two
                            "
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                      ...
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            type="number"
                            v-model="form.vd_spherical_left_right_eye_two"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                      ...
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            type="number"
                            v-model="form.vd_cylinder_left_right_eye_two"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    <v-list two-line>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content>
                          <v-list-item-title
                            class="body-1 font-weight-bold"
                            v-if="this.form.ta_sys_options2"
                          >
                            {{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.type_dias." +
                                  this.form.ta_sys_options2
                              )
                            }}
                            / {{ this.form.ta_sys2 }}
                          </v-list-item-title>
                        ...
                        <v-list-item-content>
                          <v-list-item-title
                            class="body-1 font-weight-bold"
                            v-if="this.form.ta_dias_options2"
                          >
                            {{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.type_dias." +
                                  this.form.ta_dias_options2
                              )
                            }}
                            / {{ this.form.ta_dias2 }}
                          </v-list-item-title>
                      ...
                      <v-list-item>
                        <v-list-item-content>
                          <v-list-item-title class="body-1 font-weight-bold">
                            <v-tooltip right v-if="this.form.limbe_re">
                              <div
                                style="width: 300px"
                                class="text-center font-weight-bold body-2 white--text text--d ken-1"
                              >
                        ...
                        <v-list-item-content>
                          <v-list-item-title class="body-1 font-weight-bold">
                            <v-tooltip right v-if="this.form.limbe_le">
                              <div
                                style="width: 300px"
                                class="text-center font-weight-bold body-2 white--text text--d ken-1"
                              >
                      ...
                      <v-list-item>
                        <v-list-item-content>
                          <v-list-item-title class="body-1 font-weight-bold">
                            <v-tooltip right v-if="this.form.fundus_re">
                              <div
                                style="width: 300px"
                                class="text-center font-weight-bold body-2 white--text text--d ken-1"
                              >
                        ...
                        <v-list-item-content>
                          <v-list-item-title class="body-1 font-weight-bold">
                            <v-tooltip right v-if="this.form.fundus_le">
                              <div
                                style="width: 300px"
                                class="text-center font-weight-bold body-2 white--text text--d ken-1"
                              >
    ...
    form: {
      ...
      default: function () {
        return {
          ...
          functional_exploration_other: null,
