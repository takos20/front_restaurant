<template>
  <v-dialog v-model="dialog.show" persistent max-width="1550">
    <div v-if="isEnded">Ended.</div>

    <v-card style="background-color: #eceff1">
      <!-- <v-toolbar dark color="#f5f5f5" dense max-width="1530px">
            ...
            <transition name="fade-transition" mode="out-in">
              <v-stepper-content step="1">
                <v-container class="mt-1" fluid>
                  <v-card elevation="3" rounded class="pa-4">
                    <v-row wrap>
                      ...
                      <v-col cols="12" sm="4" class="mb-0 py-0">
                        <v-text-field
                          ...
                          :label="
                            $vuetify.lang.t(
                              '$vuetify.consultation.cols.code.title'
                            )
                          "
                          class="font-weight-bold"
                          readonly
                ...
                <v-container class="mt-1" fluid>
                  <v-card elevation="3" rounded class="pa-4">
                    <div
                      class="text-h7 font-weight-bold mb-4 white--text blue darken-5 text-center"
                      style="height: 30px"
                    >
                      {{
                        $vuetify.lang.t(
              ...
              clearable-->
                    ...
                    <v-container fluid>
                      ...
                      >
                        <v-col cols="12" class="d-flex justify-center">
                          <v-card
                            class="pa-6 rounded-lg elevation-2"
                            style="
                              width: 100%;
                              max-width: 1200px;
                          ...
                          >
                            ...
                            <v-card-text class="pt-2">
                              ...
                              <!-- Medical Section -->
                              <v-row
                                v-if="category.categoryBack === 'MEDICAL'"
                                class="mb-4"
                                style="margin-top: -60px"
                              >
                                <v-col cols="12" md="6">
                                  <v-subheader class="font-weight-bold mb-2">
                                    {{
                                      $vuetify.lang.t(
                              ...
                              <!-- Anesthesia -->
                              <v-row
                                v-if="category.categoryBack === 'ANESTHESIA'"
                                class="mb-4"
                                style="margin-top: -60px"
                              >
                                <v-col cols="12" md="6">
                                  ...
                                  <v-select
                                    dense
                                    outlined
                                    v-model="category.anesthesia"
                                    color="primary"
                                    :items="optionANES.type_anes"
                                    deletable-chips
                                    clearable
                                  />
                                </v-col>
                                <v-col cols="12" md="6">
                                  <v-textarea
                                    ...
                                    auto-grow
                                    outlined
                                    v-model="category.descriptionAnesthesia"
                                    color="primary"
                                    :label="
                                      $vuetify.lang.t(
                                        '$vuetify.background.cols.description.title'
                              ...
                              <!-- Family -->
                              <v-row
                                v-if="category.categoryBack === 'FAMILY'"
                                class="mb-4"
                                style="margin-top: -60px"
                              >
                                <v-col cols="12">
                              ...
                              <!-- Allergy -->
                              <v-row
                                v-if="category.categoryBack === 'ALLERGY'"
                                class="mb-4"
                                style="margin-top: -60px"
                              >
                                <v-col cols="12">
                        ...
                        <v-row>
                          ...
                          <v-col cols="4">
                            <v-text-field
                              ...
                              :label="
                                $vuetify.lang.t(
                                  '$vuetify.ophtamologique.cols.type_dias.RIGHT_ARM'
                                )
                              "
                              color="primary"
                              readonly
                          ...
                          <v-col cols="4" class="mt-1">
                            <v-text-field
                              ...
                              :label="
                                $vuetify.lang.t(
                                  '$vuetify.ophtamologique.cols.type_dias.LEFT_ARM'
                                )
                              "
                              color="primary"
                              readonly
                      ...
                      <v-col cols="12" sm="4" class="mb-0 py-0">
                        <v-row>
                          ...
                          <v-col cols="3">
                            <v-subheader class="font-weight-bold">{{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.acuity.TSWTC"
                              )
                            }}</v-subheader>
                          </v-col>
                          <v-col cols="6" class="mt-1">
                      ...
                      <v-col cols="12" sm="4" class="mb-0 py-0">
                        <v-row>
                          ...
                          <v-col cols="3">
                            <v-subheader class="font-weight-bold">{{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.acuity.TSWC"
                              )
                            }}</v-subheader>
                          </v-col>
                          <v-col cols="6" class="mt-1">
                ...
                <v-container class="mt-1" fluid>
                  <v-card elevation="3" rounded class="pa-4">
                    ...
                    >
                      {{
                        $vuetify.lang.t("$vuetify.consultation.exam_exterior")
                      }}
                    </div>
                    <v-row wrap>
                      <v-col cols="12" sm="12" class="mb-0 py-0">
                      ...
                      <v-col cols="12" sm="12" class="mb-0 py-0">
                        <v-row>
                          <v-col cols="2">
                            <v-subheader class="font-weight-bold">{{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.anteriors_segments.limbe.title"
                              )
                            }}</v-subheader>
                          </v-col>
                          <v-col cols="5" class="mt-1">
                ...
                <v-container class="mt-1" fluid>
                  <v-card elevation="3" rounded class="pa-4">
                    ...
                    >
                      {{
                        $vuetify.lang.t(
                          "$vuetify.ophtamologique.cols.posterior_segments.title"
                        )
                      }}
                    </div>
                    <v-row wrap>
                      <v-col cols="12" sm="12" class="mb-0 py-0">
                        <v-row>
                          <v-col cols="2">
                            <v-subheader class="font-weight-bold">{{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.anteriors_segments.dilatation.title"
                              )
                            }}</v-subheader>
                          </v-col>
                          <v-col cols="5" class="mt-1">
                      ...
                      <v-col cols="12" sm="12" class="mb-0 py-0">
                        <v-row>
                          <v-col cols="2">
                            <v-subheader class="font-weight-bold">{{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.anteriors_segments.fundus.title"
                              )
                            }}</v-subheader>
                          </v-col>
                          <v-col cols="5" class="mt-1">
              ...
              <v-container class="mt-1" fluid>
                <v-card elevation="3" rounded class="pa-4">
                  ...
                  >
                    {{
                      $vuetify.lang.t(
                        "$vuetify.ophtamologique.cols.investigation.title"
                      )
                    }}
                  </div>
                  <v-row wrap>
                    <v-col cols="12" sm="6" class="mb-0 py-0">
                      <div
                        class="text-h7 font-weight-bold mb-4 black--text text-center"
                      >
                        {{
                          $vuetify.lang.t(
                            "$vuetify.ophtamologique.cols.functional_exploration.title"
                          )
                        }}
                      </div>
                      <div class="d-flex justify-space-around">
                        <v-row wrap>
                          <v-col cols="12" sm="10" class="my-2">
                            <v-autocomplete
                              v-model="form.functional_exploration"
                              :items="itemsFunctional_exploration"
                              :loading="isLoadingFunctional_exploration"
                              :search-input.sync="searchFunctional_exploration"
                              item-text="title"
                              color="primary"
                              item-value="id"
                          ...
                          <v-col cols="12" sm="1" class="my-4">
                            <v-tooltip top>
                              <template v-slot:activator="{ on }">
                                <v-icon
                                  @click="createFunctional_exploration()"
                                  v-on="on"
                                >
                          ...
                          <v-col cols="12" sm="1" class="my-4">
                            <v-tooltip top>
                              <template v-slot:activator="{ on }">
                                <v-icon
                                  @click="refreshItemsFunctional_exploration()"
                                  v-on="on"
                                >
                                  mdi-refresh
                                </v-icon>
        ...
        >
          ...
          {{ $vuetify.lang.t("$vuetify.btn.refresh") }}
                      ...
                      <v-data-table
                        ...
                        :headers="headers"
                        :items="itemsFunctional_explorations"
                        :items-per-page="itemPerPage"
                        :loading="loadingDetailsFunctional_exploration.list"
                                ...
                                <td class="subtitle-2">
                                  {{
                                    item.functional_exploration
                                      ? item.functional_exploration.code
                                      : "-"
                                  }}
                                </td>
                                <td class="subtitle-2">
              ...
              <td class="subtitle-2">{{ item.conclusion }}</td> -->
                                  ...
                                  <template>
                                    <v-tooltip bottom>
                                      <template v-slot:activator="{ on }">
                                        <v-btn
                                          @click="
                                            deleteItemFunctional_exploration(
                                              item
                                            )
                                          "
                                          color="red"
                      ...
                      <delete-item
                        :dialog="dialogDeleteFunctional_exploration"
                        :messages="messagesDelete"
                        :urlItems="urlDeleteItems"
                        @getItemsDetails="getItemsDetailsFunctional_exploration"
                      ></delete-item>
                    </v-col>
                    <v-col cols="12" sm="6" class="mb-0 py-0">
                      <div
                          ...
                          <v-hover>
                            <tbody slot-scope="{ hover }">
                              <tr :key="item.id" v-for="item in items">
                                <td class="subtitle-2">
                                  {{
                                    item.laboratory ? item.laboratory.code : "-"
                                  }}
                                </td>
                                <td class="subtitle-2">
                                  {{
                                ...
                                <td class="subtitle-2" width="50px">
                                  <template>
                                    <v-tooltip bottom>
                                      <template v-slot:activator="{ on }">
                                        <v-btn
                                          @click="deleteItemLaboratory(item)"
                                          color="red"
                                          icon
                                          text
                                          v-on="on"
              ...
              <v-container class="mt-1" fluid>
                <v-card elevation="3" rounded class="pa-4">
                  ...
                  >
                    {{
                      $vuetify.lang.t(
                        "$vuetify.ophtamologique.cols.investigation.titleO"
                      )
                    }}
                  </div>
                  <v-row wrap>
                    <v-col cols="12" sm="12" class="mb-0 py-0">
                      <vue-editor
                        v-model="form.functional_exploration_other"
                      ></vue-editor>
                    </v-col>
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-btn
                        color="primary"
                        @click="print_other_invest_init()"
                        class="mr-2 my-2 white--test"
                        depressed
                        :loading="loadingBtn"
                      >
                        <v-icon left>mdi-printer</v-icon>
                        {{ $vuetify.lang.t("$vuetify.ordinance.empty_form") }}
                      </v-btn>
                    </v-col>
                    <!--                  <v-col cols="12" sm="12" class="mb-0 py-0">-->
                    <!--                    <v-textarea-->
              ...
              <v-container class="mt-1" fluid>
                <v-card elevation="3" rounded class="pa-4">
                  ...
                  >
                    {{
                      $vuetify.lang.t(
                        "$vuetify.ophtamologique.cols.investigation.titleResult"
                      )
                    }}
                  </div>
                  <v-row wrap>
                    <v-col cols="12" sm="12" class="mb-0 py-0">
                      <vue-editor
                        v-model="form.investigation_result"
                      ></vue-editor>
                    </v-col>
                  </v-row>
                </v-card>
                      ...
                      <div class="d-flex justify-space-around">
                        <v-row wrap>
                          ...
                          <v-col cols="12" sm="1" class="my-4">
                            <v-tooltip top>
                              <template v-slot:activator="{ on }">
                                <v-icon @click="createDiagnosticOd()" v-on="on">
                                  mdi-plus-circle-outline
                                </v-icon>
                              </template>
                              <span>{{
        ...
        >
          ...
          {{ $vuetify.lang.t("$vuetify.btn.refresh") }}
              ...
              <td class="subtitle-2">{{ item.conclusion }}</td> -->
                                ...
                                <td class="subtitle-2" width="50px">
                                  <template>
                                    <v-tooltip bottom>
                                      <template v-slot:activator="{ on }">
                                        <v-btn
                                          @click="deleteItemDiagnosticOd(item)"
                                          color="red"
                                          icon
                                          text
                                          v-on="on"
                      ...
                      <delete-item
                        :dialog="dialogDeleteDiagnosticOd"
                        :messages="messagesDelete"
                        :urlItems="urlDeleteItems"
                      ...
                      <div class="d-flex justify-space-around">
                        <v-row wrap>
                          ...
                          <v-col cols="12" sm="1" class="my-4">
                            <v-tooltip top>
                              <template v-slot:activator="{ on }">
                                <v-icon @click="createDiagnosticOg()" v-on="on">
                                  mdi-plus-circle-outline
                                </v-icon>
                              </template>
                              <span>{{
                                ...
                                <td class="subtitle-2" width="50px">
                                  <template>
                                    <v-tooltip bottom>
                                      <template v-slot:activator="{ on }">
                                        <v-btn
                                          @click="deleteItemDiagnosticOg(item)"
                                          color="red"
                                          icon
                                          text
                                          v-on="on"
                  ...
                  <v-row wrap>
                    ...
                    <v-col cols="12" sm="10" class="mb-0 py-0">
                      <v-textarea
                        dense
                        :label="
                          $vuetify.lang.t('$vuetify.ordinance.references')
                        "
                        :rows="3"
                        outlined
                    ...
                    <v-col cols="12" sm="10" class="mb-0 py-0">
                      <v-textarea
                        dense
                        :label="$vuetify.lang.t('$vuetify.ordinance.report')"
                        :rows="3"
                        outlined
                        v-model="form.report"
                        color="primary"
                    ...
                    <!-- <v-col cols="12" sm="10" class="mb-0 py-0">
                      <v-textarea
                        dense
                        :label="$vuetify.lang.t('$vuetify.ordinance.sumup')"
                        :rows="3"
                        outlined
                        v-model="form.sumup"
                        color="primary"
            ...
            <v-stepper-content step="3">
              <v-container class="mt-1" fluid>
                <v-card elevation="3" rounded class="pa-4">
                  <!-- <div class="text-h7 font-weight-bold mb-4">
      ...
      {{ $vuetify.lang.t("$vuetify.ophtamologique.cols.acuity.title") }}
                  ...
                  <v-row wrap style="margin-top: -15px">
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t(
                          "$vuetify.subjective_refraction.cols.left_right_eye.title"
                        )
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="
                              form.refraction_vd_spherical_left_right_eye_one
                            "
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                      ...
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="
                              form.refraction_vd_cylinder_left_right_eye_one
                            "
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            v-model="form.refraction_vd_axis_left_right_eye"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="8">
                          <v-select
                            dense
                            v-model="form.refraction_vd_va_left_right_eye"
                            color="primary"
                            :items="optionsAC.type_ac"
                            deletable-chips
                            clearable
                  ...
                  <v-row wrap style="margin-top: -15px">
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t(
                          "$vuetify.subjective_refraction.cols.left_right_glass_eye.title"
                        )
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="12" sm="2" class="mb-0 py-0">
              ...
              <v-container class="mt-1" fluid v-if="this.form.age <= 18">
                <v-card elevation="3" rounded class="pa-4">
                  <!-- <div class="text-h7 font-weight-bold mb-4">
      {{ $vuetify.lang.t("$vuetify.ophtamologique.cols.acuity.title") }}
    </div> -->
                  ...
                  >
                    {{
                      $vuetify.lang.t("$vuetify.consultation.cols.rss.title")
                    }}
                  </div>
                  <v-row wrap>
                    <v-col cols="12" sm="2" class="mb-0 py-0"> </v-col>
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_spherical_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_cylinder_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_axis_right_eye"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="8">
                          <v-select
                            dense
                            v-model="form.rss_vd_va_right_eye"
                            color="primary"
                            :items="optionsAC.type_ac"
                            deletable-chips
                            clearable
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_spherical_left_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_cylinder_left_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_axis_left_eye"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="8">
                          <v-select
                            dense
                            v-model="form.rss_vd_va_left_eye"
                            color="primary"
                            :items="optionsAC.type_ac"
                            deletable-chips
                            clearable
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_spherical_left_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_cylinder_left_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            v-model="form.rss_vd_axis_left_right_eye"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="8">
                          <v-select
                            dense
                            v-model="form.rss_vd_va_left_right_eye"
                            color="primary"
                            :items="optionsAC.type_ac"
                            deletable-chips
                            clearable
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <!-- <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.rss_vn_spherical_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                      ...
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            step="0.01"
                            v-model="form.rss_vn_cylinder_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <!-- <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            v-model="form.rss_vn_axis_right_eye"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <!-- <v-row>
                        ...
                        <v-col cols="8">
                          <v-select
                            dense
                            v-model="form.rss_vn_va_right_eye"
                            color="primary"
                            :items="optionsAC.type_ac"
                            deletable-chips
                            clearable
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.vd_spherical_left_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            dense
                            v-model="form.vd_cylinder_left_right_eye_one"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-text-field
                            dense
                            v-model="form.vd_axis_left_right_eye"
                            color="primary"
                            class="font-weight-bold"
                          ></v-text-field>
                        </v-col>
                    ...
                    >
                      <v-row>
                        ...
                        <v-col cols="8">
                          <v-select
                            dense
                            v-model="form.vd_va_left_right_eye"
                            color="primary"
                            :items="optionsAC.type_ac"
                            deletable-chips
                            clearable
      ...
      {{ $vuetify.lang.t("$vuetify.ophtamologique.cols.acuity.title") }}
                  ...
                  <v-row>
                    <v-col cols="2">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t("$vuetify.patient_glass.cols.exp.title")
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="1" class="mt-1">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t("$vuetify.patient_glass.cols.exp.od")
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="2" class="mt-1">
                      <v-text-field
                    ...
                    <v-col cols="1" class="mt-1">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t("$vuetify.patient_glass.cols.exp.og")
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="2" class="mt-1">
                      <v-text-field
                    ...
                    <v-col cols="1" class="mt-1">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t("$vuetify.patient_glass.cols.exp.odg")
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="2" class="mt-1">
                      <v-text-field
                        dense
                        v-model="form.exp_odg"
                        color="primary"
                        class="font-weight-bold"
                      ></v-text-field>
                    </v-col>
                  ...
                  <v-row>
                    <v-col cols="2">
                      <v-subheader class="font-weight-bold">{{
                        $vuetify.lang.t("$vuetify.patient_glass.cols.hp.title")
                      }}</v-subheader>
                    </v-col>
                    <v-col cols="2" class="mt-1">
                      <v-subheader class="font-weight-bold">{{
                    ...
                    <v-col cols="12" sm="12" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="4">
                          <v-subheader class="font-weight-bold">{{
                            $vuetify.lang.t(
                              "$vuetify.patient_glass.cols.hue.title"
                            )
                          }}</v-subheader>
                        </v-col>
                        <v-col cols="8">
                    ...
                    <v-col cols="12" sm="12" class="mb-0 py-0">
                      <v-row>
                        <v-col cols="4">
                          <v-subheader class="font-weight-bold">{{
                            $vuetify.lang.t(
                              "$vuetify.patient_glass.cols.cat_hue.title"
                            )
                          }}</v-subheader>
                        </v-col>
                        <v-col cols="8">
                          <v-select
                            v-model="form.cat_hue"
                            dense
                            color="primary"
                            :items="optionCH.typeCH"
                            deletable-chips
                            clearable
                            class="font-weight-bold"
                          ></v-select>
              ...
              <!-- <v-card max-width="1520px" class="mt-2">
                <div
                  ...
                  <v-col class="mb-0 py-0" cols="12" sm="6">
                    <v-row dense>
                      <v-col cols="12" sm="6" md="4" lg="3">
                        <v-card
                          class="pa-4 d-flex flex-column align-center justify-center text-center summary-card"
                          outlined
                          rounded
                          role="region"
                        >
                          ...
                          <span
                            class="text-h7 font-weight-bold mt-2 primary--text"
                            v-if="form.ta_sys"
                          >
                            {{
                              $vuetify.lang.t(
                      ...
                      <v-col cols="12" sm="6" md="4" lg="3">
                        ...
                        >
                          ...
                          <span
                            class="mt-3 font-weight-bold primary--text text-body-2"
                          ...
                          >
                            <div style="display: inline">
                              ...
                              >
                                {{
                                  $vuetify.lang.t(
                                    "$vuetify.ophtamologique.cols.interrogation." +
                                      content
                                  )
                                }}
                              </v-chip>
                      ...
                      <v-col cols="12" sm="6" md="4" lg="3">
                        ...
                        >
                          ...
                          >
                            ...
                            {{
                              $vuetify.lang.t(
                                "$vuetify.ophtamologique.cols.anteriors_segments.crystalline.RE"
                              )
                            }}
                          </span>
                          <span
                      ...
                      <v-col cols="12" sm="12">
                        ...
                        >
                          ...
                          >
                            {{
                              $vuetify.lang.t(
                                "$vuetify.consultation.exam_exterior"
                              )
                            }}
                          </span>
                          <span
                      ...
                      <v-col cols="12" sm="12">
                        ...
                        >
                          ...
                          >
                            {{
                              $vuetify.lang.t(
                                "$vuetify.function_exploration.title"
                              )
                            }}
                          </span>
                          <span
                          ...
                          >
                            <div style="display: inline">
                              <v-chip
                                ...
                                label
                                class="ma-1"
                                v-for="item in this.itemsLaboaratory"
                                :key="item.id"
                              >
                                {{
                                  ...
                                  <v-card>
                                    ...
                                    <v-card-text>
                                      <v-flex
                                        v-for="(
                                          item, index
                                        ) in this.form.functional_exploration_other.split(
                                          '<p><br></p>'
                                        )"
                                        :key="index"
                                      >
                                  ...
                                  <v-card>
                                    ...
                                    <v-card-text>
                                      <v-flex
                                        v-for="(
                                          item, index
                                        ) in this.form.investigation_result.split(
                                          '<p><br></p>'
                                        )"
                                        :key="index"
                                      >
                    ...
                    <v-row dense>
                      <v-col cols="12" sm="6">
                        ...
                        >
                          <!-- Title -->
                          <span
                            class="text-caption font-weight-large text--secondary"
                          >
                      ...
                      <v-col cols="12" sm="12">
                        ...
                        >
                          <span
                            class="text-caption font-weight-medium text--secondary"
                          >
                            {{ $vuetify.lang.t("$vuetify.ordinance.report") }}
                          </span>
                          <span
                            class="mt-3 font-weight-bold primary--text text-body-2"
                            style="white-space: normal; word-break: break-word"
                      ...
                      <v-col cols="12" sm="12">
                        ...
                        >
                          <span
                            class="text-caption font-weight-medium text--secondary"
                          >
                            {{ $vuetify.lang.t("$vuetify.ordinance.sumup") }}
                          </span>
                          <span
                            class="mt-3 font-weight-bold primary--text text-body-2"
                            style="white-space: normal; word-break: break-word"
                    ...
                    <v-row dense>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .refraction_vd_spherical_left_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .refraction_vd_cylinder_left_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            ...
                                            <v-col cols="6" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .refraction_vd_axis_left_right_eye
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            ...
                                            <v-col cols="6" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .refraction_vd_va_left_right_eye
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                      ...
                      <v-col cols="12" sm="6" md="4" lg="3">
                        ...
                        >
                          ...
                          >
                            {{
                              $vuetify.lang.t(
                                "$vuetify.consultation.cols.rss.title"
                              )
                            }}
                          </span>
                          <br />
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .rss_vd_spherical_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                        ...
                                        >
                                          <v-row>
                                            ...
                                            <v-col cols="6" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form.rss_vd_axis_left_eye
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .rss_vd_spherical_left_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .rss_vd_cylinder_left_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .rss_vn_spherical_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .vd_spherical_left_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                          ...
                                          <v-row>
                                            <v-col cols="12" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form
                                                    .vd_cylinder_left_right_eye_one
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                                        ...
                                        >
                                          <v-row>
                                            ...
                                            <v-col cols="6" class="mt-3">
                                              ...
                                              >
                                                {{
                                                  this.form.vd_va_left_right_eye
                                                }}
                                              </v-list-item-subtitle>
                                            </v-col>
                                          </v-row>
                      ...
                      <v-col cols="12" sm="6" md="4" lg="3">
                        ...
                        >
                          ...
                          <br />
                          <span class="text-h7 font-weight-bold primary--text">
                            <v-layout row wrap align-left justify-left>
                              <v-tooltip bottom color="grey">
                                <template v-slot:activator="{ on }">
                                  <v-icon v-on="on">
...
export default {
    ...
    form: {
      ...
      default: function () {
        return {
          ...
          ta_sys_options: null,
          ta_sys2: null,
          ta_sys_options2: null,
          ta_dias: null,
          ta_dias_options: null,
          ta_dias2: null,
          ta_dias_options2: null,
          iop_od: null,
          left_eye_vas: null,
          left_eye_vaws: null,
          ...
          vd_va_left_right_eye: null,
          vd_axis_left_right_eye: null,
          vd_cylinder_left_right_eye_two: null,
          vd_cylinder_left_right_eye_one: null,
          vd_spherical_left_right_eye_two: null,
          vd_spherical_left_right_eye_one: null,
          ...
          refraction_vd_va_left_right_eye: null,
          refraction_vd_axis_left_right_eye: null,
          refraction_vd_cylinder_left_right_eye_two: null,
          refraction_vd_cylinder_left_right_eye_one: null,
          refraction_vd_spherical_left_right_eye_two: null,
          refraction_vd_spherical_left_right_eye_one: null,
          ...
          rss_vn_va_left_eye: null,
          rss_vn_axis_left_eye: null,
          rss_vn_cylinder_left_eye_two: null,
          rss_vn_cylinder_left_eye_one: null,
          rss_vn_spherical_left_eye_two: null,
          rss_vn_spherical_left_eye_one: null,
          rss_vn_va_right_eye: null,
          rss_vn_axis_right_eye: null,
          rss_vn_cylinder_right_eye_two: null,
          rss_vn_cylinder_right_eye_one: null,
          rss_vn_spherical_right_eye_two: null,
          rss_vn_spherical_right_eye_one: null,
          rss_vd_va_left_eye: null,
          rss_vd_axis_left_eye: null,
          rss_vd_cylinder_left_eye_two: null,
          rss_vd_cylinder_left_eye_one: null,
          rss_vd_spherical_left_eye_two: null,
          rss_vd_spherical_left_eye_one: null,
          rss_vd_va_left_right_eye: null,
          rss_vd_axis_left_right_eye: null,
          rss_vd_cylinder_left_right_eye_two: null,
          rss_vd_cylinder_left_right_eye_one: null,
          rss_vd_spherical_left_right_eye_two: null,
          rss_vd_spherical_left_right_eye_one: null,
          rss_vd_va_right_eye: null,
          rss_vd_axis_right_eye: null,
          rss_vd_cylinder_right_eye_two: null,
          rss_vd_cylinder_right_eye_one: null,
          rss_vd_spherical_right_eye_two: null,
          rss_vd_spherical_right_eye_one: null,
          iop_og: null,
          rss: null,
          ODWC: null,
          TSWC: null,
          ...
          ODWTC: null,
          OGWTC: null,
          refraction_ODWC: null,
          refraction_TSWC: null,
          refraction_TSWTC: null,
          refraction_OGWC: null,
          refraction_ODWTC: null,
          refraction_OGWTC: null,
          symptoms: null,
          other: null,
          other_symptoms: null,
          ...
          functional_exploration_other: "<p>hello wold</p><p><br></p>",
          investigation_result: "<p>hello wold</p><p><br></p>",
          diagnostic_og: null,
  ...
  data: () => ({
    ...
    urlFunctional_exploration: "functional_explorations/all",
    ...
    dialogDeleteDiagnosticOd: {
      show: false,
    },
    dialogDeleteFunctional_exploration: {
      show: false,
    },
    days: null,
    hours: null,
    ...
    urlItemsDetailsFunctional_exploration: "details_functional_explorations",
  ...
  watch: {
    ...
    searchFunctional_exploration(value) {
      if (value === null) return;
      const params = { title: value };
      let self = this;
      this.isLoadingFunctional_exploration = true;
      this.$store
        .dispatch("request", {
          url: self.urlFunctional_exploration,
          params: params,
        })
        .then((response) => {
          self.itemsFunctional_exploration = response.data.content;
          // console.log(response.data.content);
        })
        .finally(() => (this.isLoadingFunctional_exploration = false));
    },
  ...
  created() {
    ...
    this.refreshItemsFunctional_exploration();
  },
  mounted() {
    // this.tick()
  ...
  methods: {
    ...
    // },
    base645(item) {
      return item.split('src="')[1].split('">')[0];
      // this.imageUrl = this.form.functional_exploration_other.split('src="');
    },
    base64_result(item) {
      return item.split('src="')[1].split('">')[0];
      // this.imageUrl = this.form.functional_exploration_other.split('src="');
    ...
    print_init() {
      this.$store.dispatch("request", {
        url: this.getRoute(),
        method: this.getMethodDetail(),
        data: this.getDataFormPending(),
      });
      setTimeout(() => {
        this.print();
      }, 200);
    ...
    print_reference() {
      ...
      if (!self.$v.$invalid) {
        ...
        this.$store
          .dispatch("request", {
            url: self.urlItemsDetails_ordinance + "/print" + "?type=reference",
            method: "POST",
            data: self.getDataFormdetails(),
          })
          .then((response) => {
    ...
    print_other_invest() {
      ...
      if (!self.$v.$invalid) {
        ...
        this.$store
          .dispatch("request", {
            url:
              self.urlItemsDetails_ordinance + "/print" + "?type=other_invest",
            method: "POST",
            data: self.getDataFormdetails(),
          })
          .then((response) => {
    ...
    print_report() {
      ...
      if (!self.$v.$invalid) {
        ...
        this.$store
          .dispatch("request", {
            url: self.urlItemsDetails_ordinance + "/print" + "?type=report",
            method: "POST",
            data: self.getDataFormdetails(),
          })
          .then((response) => {
    ...
    print_sumup() {
      ...
      if (!self.$v.$invalid) {
        ...
        this.$store
          .dispatch("request", {
            url: self.urlItemsDetails_ordinance + "/print" + "?type=sumup",
            method: "POST",
            data: self.getDataFormdetails(),
          })
          .then((response) => {
    ...
    print_glass_init() {
      this.$store.dispatch("request", {
        url: this.getRoute(),
        method: this.getMethodDetail(),
        data: this.getDataFormRefraction(),
      });
      setTimeout(() => {
        this.print_glass();
      }, 200);
    ...
    resetDataForm() {
      ...
      this.form.functional_exploration_other = "<p>hello wold</p><p><br></p>";
      this.form.investigation_result = "<p>hello wold</p><p><br></p>";
    },
    ...
    getOptionsAnesthesia() {
      // On pouvait aussi utliser le forEach au lieu de   _.eaach
      let self = this;
      this._.each(this.$store.getters.mode_anesthesia, (type_anes) => {
        self.optionANES.type_anes.push({
          text: self.$vuetify.lang.t(type_anes.text),
          value: type_anes.value,
        });
      });
    },
    getOptionsTM() {
    ...
    getOptionsH() {
      // On pouvait aussi utliser le forEach au lieu de   _.eaach
      let self = this;
      this._.each(this.$store.getters.hue, (typeH) => {
        self.optionH.typeH.push({
          text: self.$vuetify.lang.t(typeH.text),
          value: typeH.value,
        });
      });
    },
    getOptionsCH() {
      // On pouvait aussi utliser le forEach au lieu de   _.eaach
      let self = this;
      this._.each(this.$store.getters.cat_hue, (typeCH) => {
        self.optionCH.typeCH.push({
          text: self.$vuetify.lang.t(typeCH.text),
          value: typeCH.value,
        });
      });
    },
    ...
    getOptionsRSS() {
      // On pouvait aussi utliser le forEach au lieu de   _.eaach
      let self = this;
      this._.each(this.$store.getters.type_Billable, (type_rss) => {
        self.optionsRSS.type_rss.push({
          text: self.$vuetify.lang.t(type_rss.text),
          value: type_rss.value,
        });
      });
    },
    getOptionsOther() {
    ...
    getDataFormPending() {
      let dataPending = {
        ...
        fundus_re: this.form.fundus_re,
        dilatation_re: this.form.dilatation_re,
        eyelids_le: this.form.eyelids_le,
        fundus_le: this.form.fundus_le,
        dilatation_le: this.form.dilatation_le,
        ...
        limbe_re: this.form.limbe_re,
        limbe_le: this.form.limbe_le,
        ...
        exam_exterior: this.form.exam_exterior,
        gen_spec_face: this.form.gen_spec_face,
        diagnostic_od: this.form.diagnostic_od,
        diagnostic_og: this.form.diagnostic_og,
        reference: this.form.reference,
        report: this.form.report,
        sumup: this.form.sumup,
        diagnostic_other: this.form.diagnostic_other,
        investigation_result: this.form.investigation_result,
        functional_exploration_other: this.form.functional_exploration_other,
    ...
    getDataFormRefraction() {
      let data = {
        refractionPart: "true",
        status: "PENDING",
        consultation: this.form.consultation,
        rss: this.form.rss,
        hp_od: this.form.hp_od,
        hp_og: this.form.hp_og,
        exp_od: this.form.exp_od,
        exp_og: this.form.exp_og,
        exp_odg: this.form.exp_odg,
        hue: this.form.hue,
        cat_hue: this.form.cat_hue,
        ...
        vd_va_left_right_eye: this.form.vd_va_left_right_eye,
        vd_axis_left_right_eye: this.form.vd_axis_left_right_eye,
        vd_cylinder_left_right_eye_two:
          this.form.vd_cylinder_left_right_eye_two,
        vd_cylinder_left_right_eye_one:
          this.form.vd_cylinder_left_right_eye_one,
        vd_spherical_left_right_eye_two:
          this.form.vd_spherical_left_right_eye_two,
        vd_spherical_left_right_eye_one:
          this.form.vd_spherical_left_right_eye_one,
        ...
        refraction_vd_va_left_right_eye:
          this.form.refraction_vd_va_left_right_eye,
        refraction_vd_axis_left_right_eye:
          this.form.refraction_vd_axis_left_right_eye,
        refraction_vd_cylinder_left_right_eye_two:
          this.form.refraction_vd_cylinder_left_right_eye_two,
        refraction_vd_cylinder_left_right_eye_one:
          this.form.refraction_vd_cylinder_left_right_eye_one,
        refraction_vd_spherical_left_right_eye_two:
          this.form.refraction_vd_spherical_left_right_eye_two,
        refraction_vd_spherical_left_right_eye_one:
          this.form.refraction_vd_spherical_left_right_eye_one,
        ...
        rss_vn_va_left_eye: this.form.rss_vn_va_left_eye,
        rss_vn_axis_left_eye: this.form.rss_vn_axis_left_eye,
        rss_vn_cylinder_left_eye_two: this.form.rss_vn_cylinder_left_eye_two,
        rss_vn_cylinder_left_eye_one: this.form.rss_vn_cylinder_left_eye_one,
        rss_vn_spherical_left_eye_two: this.form.rss_vn_spherical_left_eye_two,
        rss_vn_spherical_left_eye_one: this.form.rss_vn_spherical_left_eye_one,
        rss_vn_va_right_eye: this.form.rss_vn_va_right_eye,
        rss_vn_axis_right_eye: this.form.rss_vn_axis_right_eye,
        rss_vn_cylinder_right_eye_two: this.form.rss_vn_cylinder_right_eye_two,
        rss_vn_cylinder_right_eye_one: this.form.rss_vn_cylinder_right_eye_one,
        rss_vn_spherical_right_eye_two:
          this.form.rss_vn_spherical_right_eye_two,
        rss_vn_spherical_right_eye_one:
          this.form.rss_vn_spherical_right_eye_one,
        rss_vd_va_left_eye: this.form.rss_vd_va_left_eye,
        rss_vd_axis_left_eye: this.form.rss_vd_axis_left_eye,
        rss_vd_cylinder_left_eye_two: this.form.rss_vd_cylinder_left_eye_two,
        rss_vd_cylinder_left_eye_one: this.form.rss_vd_cylinder_left_eye_one,
        rss_vd_spherical_left_eye_two: this.form.rss_vd_spherical_left_eye_two,
        rss_vd_spherical_left_eye_one: this.form.rss_vd_spherical_left_eye_one,
        rss_vd_va_left_right_eye: this.form.rss_vd_va_left_right_eye,
        rss_vd_axis_left_right_eye: this.form.rss_vd_axis_left_right_eye,
        rss_vd_cylinder_left_right_eye_two:
          this.form.rss_vd_cylinder_left_right_eye_two,
        rss_vd_cylinder_left_right_eye_one:
          this.form.rss_vd_cylinder_left_right_eye_one,
        rss_vd_spherical_left_right_eye_two:
          this.form.rss_vd_spherical_left_right_eye_two,
        rss_vd_spherical_left_right_eye_one:
          this.form.rss_vd_spherical_left_right_eye_one,
        rss_vd_va_right_eye: this.form.rss_vd_va_right_eye,
        rss_vd_axis_right_eye: this.form.rss_vd_axis_right_eye,
        rss_vd_cylinder_right_eye_two: this.form.rss_vd_cylinder_right_eye_two,
        rss_vd_cylinder_right_eye_one: this.form.rss_vd_cylinder_right_eye_one,
        rss_vd_spherical_right_eye_two:
          this.form.rss_vd_spherical_right_eye_two,
        rss_vd_spherical_right_eye_one:
          this.form.rss_vd_spherical_right_eye_one,
        refraction_ODWC: this.form.refraction_ODWC,
        refraction_TSWC: this.form.refraction_TSWC,
        refraction_TSWTC: this.form.refraction_TSWTC,
        refraction_OGWC: this.form.refraction_OGWC,
        refraction_ODWTC: this.form.refraction_ODWTC,
        refraction_OGWTC: this.form.refraction_OGWTC,
      };
      return data;
    },
    ...
    getDataFormDetailsFunctional_exploration() {
      let data = {
        consultation: this.form.consultation,
        details_consultation: this.form.consult,
        functional_exploration: this.form.functional_exploration,
      };
    ...
    setFormConsult(item) {
      ...
      this.getItemsDetailsFunctional_exploration();
      ...
      this.form.investigation_result =
        item.consultation?.[0]?.investigation_result == null
          ? "<p>hello wold</p><p><br></p>"
          : item.consultation?.[0]?.investigation_result;
      this.form.poul = item.consultation?.[0]?.poul;
      this.form.weight = item.consultation?.[0]?.weight;
      ...
      this.form.descriptionAnesthesia =
        item.consultation?.[0]?.descriptionAnesthesia;
      ...
      this.form.anesthesia = item.consultation?.[0]?.anesthesia;
      ...
      this.form.ta_sys2 = item.consultation?.[0]?.ta_sys2;
      this.form.ta_sys_options2 = item.consultation?.[0]?.ta_sys_options2;
      this.form.ta_dias = item.consultation?.[0]?.ta_dias;
      this.form.ta_dias_options = item.consultation?.[0]?.ta_dias_options;
      this.form.ta_dias2 = item.consultation?.[0]?.ta_dias2;
      this.form.ta_dias_options2 = item.consultation?.[0]?.ta_dias_options2;
      this.form.poul = item.consultation?.[0]?.poul;
      this.form.weight = item.consultation?.[0]?.weight;
      this.form.iop_od = item.consultation?.[0]?.iop_od;
      this.form.iop_og = item.consultation?.[0]?.iop_og;
      this.form.rss = item.consultation?.[0]?.rss;
      ...
      this.form.gp_vn_axis_left_eye =
        item.consultation?.[0]?.gp_vn_axis_left_eye;
      ...
      this.form.gp_vd_axis_left_eye =
        item.consultation?.[0]?.gp_vd_axis_left_eye;
      ...
      this.form.vd_va_left_right_eye =
        item.consultation?.[0]?.vd_va_left_right_eye;
      this.form.vd_axis_left_right_eye =
        item.consultation?.[0]?.vd_axis_left_right_eye;
      this.form.vd_cylinder_left_right_eye_two =
        item.consultation?.[0]?.vd_cylinder_left_right_eye_two;
      this.form.vd_cylinder_left_right_eye_one =
        item.consultation?.[0]?.vd_cylinder_left_right_eye_one;
      this.form.vd_spherical_left_right_eye_two =
        item.consultation?.[0]?.vd_spherical_left_right_eye_two;
      this.form.vd_spherical_left_right_eye_one =
        item.consultation?.[0]?.vd_spherical_left_right_eye_one;
      ...
      this.form.refraction_vd_va_left_right_eye =
        item.consultation?.[0]?.refraction_vd_va_left_right_eye;
      this.form.refraction_vd_axis_left_right_eye =
        item.consultation?.[0]?.refraction_vd_axis_left_right_eye;
      this.form.refraction_vd_cylinder_left_right_eye_two =
        item.consultation?.[0]?.refraction_vd_cylinder_left_right_eye_two;
      this.form.refraction_vd_cylinder_left_right_eye_one =
        item.consultation?.[0]?.refraction_vd_cylinder_left_right_eye_one;
      this.form.refraction_vd_spherical_left_right_eye_two =
        item.consultation?.[0]?.refraction_vd_spherical_left_right_eye_two;
      this.form.refraction_vd_spherical_left_right_eye_one =
        item.consultation?.[0]?.refraction_vd_spherical_left_right_eye_one;
      ...
      this.form.rss_vn_va_left_eye = item.consultation?.[0]?.rss_vn_va_left_eye;
      this.form.rss_vn_axis_left_eye =
        item.consultation?.[0]?.rss_vn_axis_left_eye;
      this.form.rss_vn_cylinder_left_eye_two =
        item.consultation?.[0]?.rss_vn_cylinder_left_eye_two;
      this.form.rss_vn_cylinder_left_eye_one =
        item.consultation?.[0]?.rss_vn_cylinder_left_eye_one;
      this.form.rss_vn_spherical_left_eye_two =
        item.consultation?.[0]?.rss_vn_spherical_left_eye_two;
      this.form.rss_vn_spherical_left_eye_one =
        item.consultation?.[0]?.rss_vn_spherical_left_eye_one;
      this.form.rss_vn_va_right_eye =
        item.consultation?.[0]?.rss_vn_va_right_eye;
      this.form.rss_vn_axis_right_eye =
        item.consultation?.[0]?.rss_vn_axis_right_eye;
      this.form.rss_vn_cylinder_right_eye_two =
        item.consultation?.[0]?.rss_vn_cylinder_right_eye_two;
      this.form.rss_vn_cylinder_right_eye_one =
        item.consultation?.[0]?.rss_vn_cylinder_right_eye_one;
      this.form.rss_vn_spherical_right_eye_two =
        item.consultation?.[0]?.rss_vn_spherical_right_eye_two;
      this.form.rss_vn_spherical_right_eye_one =
        item.consultation?.[0]?.rss_vn_spherical_right_eye_one;
      this.form.rss_vd_va_left_eye = item.consultation?.[0]?.rss_vd_va_left_eye;
      this.form.rss_vd_axis_left_eye =
        item.consultation?.[0]?.rss_vd_axis_left_eye;
      this.form.rss_vd_cylinder_left_eye_two =
        item.consultation?.[0]?.rss_vd_cylinder_left_eye_two;
      this.form.rss_vd_cylinder_left_eye_one =
        item.consultation?.[0]?.rss_vd_cylinder_left_eye_one;
      this.form.rss_vd_spherical_left_eye_two =
        item.consultation?.[0]?.rss_vd_spherical_left_eye_two;
      this.form.rss_vd_spherical_left_eye_one =
        item.consultation?.[0]?.rss_vd_spherical_left_eye_one;
      this.form.rss_vd_va_left_right_eye =
        item.consultation?.[0]?.rss_vd_va_left_right_eye;
      this.form.rss_vd_axis_left_right_eye =
        item.consultation?.[0]?.rss_vd_axis_left_right_eye;
      this.form.rss_vd_cylinder_left_right_eye_two =
        item.consultation?.[0]?.rss_vd_cylinder_left_right_eye_two;
      this.form.rss_vd_cylinder_left_right_eye_one =
        item.consultation?.[0]?.rss_vd_cylinder_left_right_eye_one;
      this.form.rss_vd_spherical_left_right_eye_two =
        item.consultation?.[0]?.rss_vd_spherical_left_right_eye_two;
      this.form.rss_vd_spherical_left_right_eye_one =
        item.consultation?.[0]?.rss_vd_spherical_left_right_eye_one;
      this.form.rss_vd_va_right_eye =
        item.consultation?.[0]?.rss_vd_va_right_eye;
      this.form.rss_vd_axis_right_eye =
        item.consultation?.[0]?.rss_vd_axis_right_eye;
      this.form.rss_vd_cylinder_right_eye_two =
        item.consultation?.[0]?.rss_vd_cylinder_right_eye_two;
      this.form.rss_vd_cylinder_right_eye_one =
        item.consultation?.[0]?.rss_vd_cylinder_right_eye_one;
      this.form.rss_vd_spherical_right_eye_two =
        item.consultation?.[0]?.rss_vd_spherical_right_eye_two;
      this.form.rss_vd_spherical_right_eye_one =
        item.consultation?.[0]?.rss_vd_spherical_right_eye_one;
      this.form.ODWC = item.consultation?.[0]?.ODWC;
      this.form.TSWC = item.consultation?.[0]?.TSWC;
      this.form.TSWTC = item.consultation?.[0]?.TSWTC;
      ...
      this.form.refraction_ODWC = item.consultation?.[0]?.refraction_ODWC;
      this.form.refraction_TSWC = item.consultation?.[0]?.refraction_TSWC;
      this.form.refraction_TSWTC = item.consultation?.[0]?.refraction_TSWTC;
      this.form.refraction_OGWC = item.consultation?.[0]?.refraction_OGWC;
      this.form.refraction_ODWTC = item.consultation?.[0]?.refraction_ODWTC;
      this.form.refraction_OGWTC = item.consultation?.[0]?.refraction_OGWTC;
      ...
      this.form.fundus_re = item.consultation?.[0]?.fundus_re;
      this.form.fundus_le = item.consultation?.[0]?.fundus_le;
      this.form.dilatation_re = item.consultation?.[0]?.dilatation_re;
      this.form.dilatation_le = item.consultation?.[0]?.dilatation_le;
      ...
      this.form.anterior_chamber_re =
        item.consultation?.[0]?.anterior_chamber_re;
      this.form.anterior_chamber_le =
        item.consultation?.[0]?.anterior_chamber_le;
      ...
      this.form.hue = item.consultation?.[0]?.hue;
      this.form.cat_hue = item.consultation?.[0]?.cat_hue;
      this.form.exp_od = item.consultation?.[0]?.exp_od;
      this.form.exp_og = item.consultation?.[0]?.exp_og;
      this.form.hp_od = item.consultation?.[0]?.hp_od;
      this.form.hp_og = item.consultation?.[0]?.hp_og;
      this.form.exp_odg = item.consultation?.[0]?.exp_odg;
      this.form.limbe_le = item.consultation?.[0]?.limbe_le;
      this.form.limbe_re = item.consultation?.[0]?.limbe_re;
      this.form.iop_re = item.consultation?.[0]?.iop_re;
      this.form.iop_le = item.consultation?.[0]?.iop_le;
      this.form.decision = item.consultation?.[0]?.decision;
      ...
      this.form.exam_exterior = item.consultation?.[0]?.exam_exterior;
      this.form.gen_spec_face = item.consultation?.[0]?.gen_spec_face;
      this.form.diagnostic_od = item.consultation?.[0]?.diagnostic_od;
      this.form.diagnostic_og = item.consultation?.[0]?.diagnostic_og;
      this.form.sumup = item.consultation?.[0]?.sumup;
      this.form.reference = item.consultation?.[0]?.reference;
      this.form.diagnostic_other = item.consultation?.[0]?.diagnostic_other;
      this.form.report = item.consultation?.[0]?.report;
      this.form.functional_exploration_other =
        item.consultation?.[0]?.functional_exploration_other == null
          ? "<p>hello wold</p><p><br></p>"
          : item.consultation?.[0]?.functional_exploration_other;
      this.form.decision_exam_labo = item.consultation?.[0]?.decision_exam_labo;
      this.form.decision_ordinnance =
        item.consultation?.[0]?.decision_ordinnance;
  ...
  computed: {
    summaryItems() {
      return {
        "Spherical (Right)": this.form.sdRight,
        "Cylinder (Right)": this.form.cylRight,
        "Axis (Right)": this.form.axisRight,
        "VA (Right)": this.form.vaRight,
        "Spherical (Left)": this.form.sdLeft,
        "Cylinder (Left)": this.form.cylLeft,
        "Axis (Left)": this.form.axisLeft,
        "VA (Left)": this.form.vaLeft,
        "Near Cylinder": this.form.nearCylinder,
      };
    },
