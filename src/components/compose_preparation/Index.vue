  ...
  <div>
    ...
    <v-card class="pb-4">
      <div class="mt-5 mx-5">
        <template
          v-if="
            _.includes(this.$auth.user().permissions, 'add_composepreparation')
          "
        >
...
export default {
  ...
  data: () => ({
    ...
    urlDeleteItems: "compose_preparations",
    deleteItems: "/compose_preparations",
    sortBy: ["createdAt"],
    dialogForm: {
      show: false,
      shows: {
  ...
  methods: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.compose_preparation.new.title",
        submit: "$vuetify.compose_preparation.new.submit",
        success: "$vuetify.compose_preparation.new.success",
      };
      this.form = {
        id: null,
        dish: null,
    ...
    editBills(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.compose_preparation.update.title",
        submit: "$vuetify.compose_preparation.update.submit",
        success: "$vuetify.compose_preparation.update.success",
      };
    ...
    performFilter() {
      ...
      if (self.filter.name_language !== null) {
        params["compose_ingredient_name"] = self.filter.name_language;
      }
      self._search = params;
