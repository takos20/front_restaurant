<template>
  <v-dialog v-model="dialog.show" persistent :scrim="false" max-width="980px">
    <v-card>
      <v-card-title>
        <div class="title">
              ...
              <v-row wrap>
                ...
                <v-col cols="12" sm="12" class="mb-0 py-0">
                  ...
                  <div class="d-flex justify-space-between">
                    ...
                    <v-tooltip
                      top
                      :disabled="get_billable === 0 || get_billable === 'NO'"
                    >
                      <template v-slot:activator="{ on }">
                        <v-icon
                          @click="addColumnPrice_level()"
                          :disabled="
                            get_billable === 0 || get_billable === 'NO'
                          "
                          v-on="on"
                        >
                      ...
                      <v-row>
                        ...
                        <v-col cols="12" sm="2" class="mb-0 py-0">
                          <v-text-field
                            ...
                            :label="
                              $vuetify.lang.t(
                                '$vuetify.price_level.cols.name_supplier.title'
                              )
                            "
                            class="font-weight-bold"
                            outlined
                  ...
                  <div v-for="(sheet, index) in priceLevel" :key="index">
                    <div
                    ...
                    >
                      ...
                      <v-icon
                        ...
                        style="width: 10px"
                        v-if="index > 0"
                        @click="removeColumnPrice_level(index)"
                      >
...
export default {
  ...
  methods: {
    ...
    addColumnPrice_level() {
      this.priceLevel.push({ ...this.optionsPrice_level.text });
    },
    removeColumnPrice_level(index) {
      this.priceLevel.splice(index, 1);
    },
    createD() {
    ...
    setForm(item) {
      ...
      this.price_level = item.packaging;
      ...
      this.priceLevel = item.prices_tiers;
