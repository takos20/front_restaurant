<template>
  <div>
          ...
          <v-row>
            ...
            <v-col cols="12" sm="3">
              ...
              >
                ...
                {{ Intl.NumberFormat().format(this.cashs.cash_fund) }} FCFA
            ...
            <v-col cols="12" sm="2">
              ...
              >
                ...
                : {{ Intl.NumberFormat().format(this.cashs.balance) }} FCFA
                <!--{{ sum_zero| numberformat(locale, 0, "currency", "XAF")  }}-->
              </v-chip>
            </v-col>
    ...
    <div>
      ...
      <form-movements
        color="black"
        v-if="_.includes(this.$auth.user().permissions, 'view_cash_movement')"
      ></form-movements>
    </div>
    <div>
      <div
  ...
  methods: {
    ...
    getItems() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsGet + "?id=" + this.$route.params.id,
            params: params,
          })
          .then((response) => {
            let data = response.data;
