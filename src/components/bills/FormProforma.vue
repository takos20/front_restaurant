      ...
      >
        <v-form :disabled="form.patient === null || form.bill_type === null">
          ...
          <v-card-actions style="margin-top: -25px">
            ...
            >
              {{ $vuetify.lang.t("$vuetify.bills.new.proforma") }}
            </v-btn>
  ...
  methods: {
    ...
    proforma() {
      ...
      if (!self.$v.$invalid) {
        ...
        this.$store
          .dispatch("request", {
            url: self.getRoute() + "?print=1" + "&type=proforma",
            method: self.getMethod(),
            data: self.getDataForm(),
            responseType: "blob",
          })
    ...
    save_print_bills() {
      ...
      if (!self.$v.$invalid) {
        ...
        this.$store
          .dispatch("request", {
            url: self.getRoute() + "?print=1" + "&type=bills",
            method: self.getMethod(),
            data: self.getDataForm(),
            responseType: "blob",
          })
