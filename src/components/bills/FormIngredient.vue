            ...
            <v-row wrap>
              ...
              >
                <v-select
                  ...
                  color="primary"
                  :items="optionIngredient.type_action"
                  :label="
                    $vuetify.lang.t(
                      '$vuetify.ingredient.cols.type_action.title'
                    )
                  "
                  dense
              ...
              >
                <v-btn
                  ...
                  :disabled="
                    !formData.quantity ||
                    (formData.action === 'REMOVE' &&
                      formData.quantity > form.quantity_served) ||
                    formData.quantity < 0
                  "
                  type="submit"
  ...
  methods: {
    ...
    getDataFormdetails() {
      let data = {
        ...
        impact_price:
          this.formData.impact_price === null
            ? this.formData.ingredient.price_per_unit
            : this.formData.impact_price,
        total_amount: this.get_total_amount(),
        action: this.formData.action,
        item_uid: this.formData.ingredient["uid"],
        name: this.formData.ingredient["name"],
      };
