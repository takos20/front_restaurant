  ...
  >
            ...
            >
              <template>
                ...
                >
                  ...
                  {{ $vuetify.lang.t("$vuetify.insurance_settlements.title") }}
                </v-btn>
              </template>
            </v-col> -->
          </v-row>
          ...
          <v-card-text>
            <v-row wrap>
              ...
              <v-col
                ...
                style="margin-top: -15px"
                v-if="
                  this.form.bill_type === 'consultation' &&
                  this.get_product_code.startsWith('TEC')
                "
              >
                <v-select
                  v-model="formData.type_consult"
                  color="primary"
                  :items="optionTypeConsult.type_consultation"
                  :label="
                    $vuetify.lang.t(
                      '$vuetify.consultation.cols.type_consultation.title'
                    )
                  "
                  :placeholder="
                    $vuetify.lang.t(
              ...
              >
                <v-select
                  v-model="formData.type_emergency"
                  color="primary"
                  :items="optionTypeEmergency.type_emergency"
                  :label="
                    $vuetify.lang.t(
                      '$vuetify.consultation.cols.type_emergency.title'
                    )
                  "
                  :placeholder="
                    $vuetify.lang.t(
              ...
              >
                <v-text-field
                  ...
                  dense
                  v-model="formData.delivery_cash"
                ></v-text-field>
              </v-col>
              <v-col
                cols="12"
        ...
        <v-form @submit.prevent="saveDetails">
          ...
          <v-card-text>
            <v-row wrap>
              ...
              <v-col cols="12" sm="6" class="mb-0 py-0" style="margin-top: 5px">
                <v-autocomplete
                  v-model="formData.details_stock"
                  :items="itemsProduct"
                  :loading="isLoading"
        ...
        <v-form :disabled="form.patient === null || form.bill_type === null">
          <v-card-text>
            <v-row wrap>
              ...
              <!-- <v-col
                ...
                class="mb-0 py-0"
                style="margin-top: 15px"
                v-if="form.payment_method === 'BANK_CARD'"
              >
                <v-text-field
          ...
          <v-card-actions style="margin-top: -20px">
            ...
            <v-btn
              ...
              @click="save_print_bills()"
              :disabled="
                form.amount_received == null || form.payment_method == 'NO_PAY'
              "
            >
              {{ $vuetify.lang.t("$vuetify.bills.new.save_print_bills") }}
            </v-btn>
              ...
              <tbody>
                <tr :key="item.id" v-for="item in items">
                  ...
                  <td class="subtitle-2">
                    <div v-if="editedRowId === item.id">
                      <v-text-field
                        v-model="editedRow.insurance_patient"
                        dense
                        readonly
                        hide-details
                      />
    ...
    <v-card>
      ...
      <v-form style="margin-top: 15px">
        <v-card-text>
          <v-row wrap>
            ...
            <v-col cols="12" sm="2" class="mb-0 py-0" style="margin-top: -20px">
              <v-switch
                v-model="form.had_been_paid"
                color="#4E342E"
                :label="
                  $vuetify.lang.t('$vuetify.bills.cols.had_been_paid.title')
                "
                outlined
                dense
              ></v-switch>
      ...
      <v-form>
        ...
        <!--              outlined-->
        <!--              dense-->
        <!--              v-model="get_product_public_price"-->
        <!--              readonly-->
        <!--              filled-->
        <!--            ></v-text-field>-->
        <!--            </v-col>-->
        ...
        <!--                    :disabled="-->
        <!--                      form.bills_date === null||form.bills_date === undefined-->
        <!--                    "-->
        <!--                  >-->
        <!--                    <v-icon size="30" dark-->
        <!--                      >mdi-plus-circle-multiple-outline mdi-30px</v-icon-->
        <!--                    >-->
        <!--                  </v-btn>-->
        <!--                </template>-->
        <!--              </template>-->
        ...
        <v-stepper v-model="e1">
          <v-stepper-items>
            <v-stepper-content step="1">
              <form-category @getItemsProduct="getItemsProduct"></form-category>
              <!--              <v-card-text >-->
              <!--                <v-btn-->
              ...
              <!--                <v-data-iterator-->
              <!--                    :footer-props="{-->
              <!--        'items-per-page-options': itemPerPageOptionsCat,-->
              <!--      }"-->
              <!--                    :items="itemsCategory"-->
              <!--                    :items-per-page="itemPerPageCat"-->
              <!--                    :server-items-length="meta.totalElements"-->
              ...
              <!--                                <v-tooltip bottom>-->
              <!--                                  <template v-slot:activator="{ on }">-->
              <!--                                    <v-btn class="ma-2 font-weight-black" small @click="getItemsProduct(itemCat)" v-on="on" light color="#d19b6f">-->
              ...
              <!--                      "-->
              <!--                                  >-->
              <!--          {{ $vuetify.lang.t("$vuetify.product.showProduct") }}-->
              <!--        </span>-->
              <!--                                </v-tooltip>-->
              <!--                              </v-card-text>-->
              <!--                            </div>-->
              ...
              <!--&lt;!&ndash;                          light&ndash;&gt;-->
              <!--&lt;!&ndash;                          x-small&ndash;&gt;-->
              <!--&lt;!&ndash;                          color="#d19b6f"&ndash;&gt;-->
              <!--&lt;!&ndash;                          class="mr-5"&ndash;&gt;-->
              <!--&lt;!&ndash;                          @click="formerPage"&ndash;&gt;-->
              <!--&lt;!&ndash;                      >&ndash;&gt;-->
              ...
              <!--&lt;!&ndash;                      >&ndash;&gt;-->
              <!--&lt;!&ndash;                        <v-icon>mdi-chevron-right</v-icon>&ndash;&gt;-->
              <!--&lt;!&ndash;                      </v-btn>&ndash;&gt;-->
              <!--&lt;!&ndash;                    </v-row>&ndash;&gt;-->
      ...
      <v-form style="margin-top: 5px">
        <v-card-text>
          <v-row wrap>
            <v-col cols="12" sm="3" class="mb-0 py-0">
              <v-text-field
                color="#4E342E"
                :label="$vuetify.lang.t('$vuetify.bills.cols.subtotal.title')"
                class="font-weight-bold"
                outlined
                dense
                :value="get_bills_amount"
            ...
            <v-col cols="12" sm="3" class="mb-0 py-0">
              <v-text-field
                ...
                :value="get_total"
                color="#4E342E"
                :label="$vuetify.lang.t('$vuetify.bills.cols.total.title')"
                class="font-weight-bold"
                outlined
                dense
                readonly
...
import PermitOther from "./permitOther";
...
export default {
  ...
  watch: {
    ...
    search(value) {
      ...
      if (value === null) return;
      const params = { product_name: value };
      let self = this;
      this.isLoading = true;
      this.$store
        .dispatch("request", {
  ...
  created() {
    ...
    this.getOptionsTypeEmergency();
    this.getOptionsTypeConsult();
  ...
  methods: {
    ...
    getOptionsTypeConsult() {
      // On pouvait aussi utliser le forEach au lieu de   _.eaach
      let self = this;
      this._.each(
        this.$store.getters.type_consultation,
        (type_consultation) => {
          self.optionTypeConsult.type_consultation.push({
            text: self.$vuetify.lang.t(type_consultation.text),
            value: type_consultation.value,
          });
        }
      );
    },
    getOptionsTypeEmergency() {
      // On pouvait aussi utliser le forEach au lieu de   _.eaach
      let self = this;
      this._.each(this.$store.getters.type_emergency, (type_emergency) => {
        self.optionTypeEmergency.type_emergency.push({
          text: self.$vuetify.lang.t(type_emergency.text),
          value: type_emergency.value,
        });
      });
    },
    ...
    reset_product_detail() {
      ...
      this.formData.delivery_cash = null;
    },
    reset_medical_act() {
      this.formData.details_stock = null;
      this.formData.sales_packaging = null;
    ...
    reset_detail_stock() {
      ...
      this.formData.diagnostic = null;
      this.formData.exam_investigation = null;
      this.formData.type_consult = null;
      this.formData.type_emergency = null;
    },
    reset_laboratory() {
      this.formData.medical_act = null;
      this.formData.sales_packaging = null;
    ...
    createI() {
      this.dialogFormIns.show = true;
      this.messagesIns = {
        title: "$vuetify.insurance_settlements.new.title",
        submit: "$vuetify.insurance_settlements.new.submit",
        success: "$vuetify.insurance_settlements.new.success",
      };
    },
    ...
    get_subtotal(itemProd) {
      if (itemProd.qte_served_fake === undefined) {
        ...
        let subtotal = "";
        subtotal = itemProd.qte_served_fake * itemProd.public_price;
        return subtotal;
      }
    },
    getDataFormdetails() {
      ...
      let data = {
        ...
        cash:
          this.form.cash === undefined || this.form.cash === null
            ...
            : this.form.cash["id"],
        type_accommodation: this.form.type_accommodation,
        type_emergency: this.formData.type_emergency,
        ...
        insurance:
          this.form.bill_type === "hospitalization" ? 0 : this.get_insurance,
        insurance_patient:
          this.form.bill_type === "hospitalization"
            ? 0
            : this.get_insurance_patient,
        type_consultation:
    ...
    saveRowEdit() {
      ...
      if (this.editedRow.type_consultation) {
        this.editedRow.type_consultation =
          this.editedRow.type_consultation["id"];
        this.editedRow["bill_type"] = "consultation";
      } else if (this.editedRow.details_stock) {
        this.editedRow.details_stock = this.editedRow.details_stock["id"];
      } else if (this.editedRow.medical_act) {
        this.editedRow.medical_act = this.editedRow.medical_act["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.medical_act;
      } else if (this.editedRow.laboratory) {
        this.editedRow.laboratory = this.editedRow.laboratory["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.laboratory;
      } else if (this.editedRow.radiography) {
        this.editedRow.radiography = this.editedRow.radiography["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.radiography;
      } else if (this.editedRow.surgery) {
        this.editedRow.surgery = this.editedRow.surgery["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.surgery;
      } else if (this.editedRow.checkup) {
        this.editedRow.checkup = this.editedRow.checkup["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.checkup;
      } else if (this.editedRow.diagnostic) {
        this.editedRow.diagnostic = this.editedRow.diagnostic["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.diagnostic;
      } else if (this.editedRow.room) {
        this.editedRow.room = this.editedRow.room["id"];
      } else if (this.editedRow.exam_investigation) {
        this.editedRow.exam_investigation =
          this.editedRow.exam_investigation["id"];
        this.editedRow["bill_type"] = "consultation";
        this.editedRow["type_consultation"] = this.editedRow.exam_investigation;
      }
  ...
  computed: {
    ...
    get_assured() {
      ...
      if (
        ...
        response = this.formData.type_consultation?.is_assured;
      }
      ...
      if (
        ...
        response = this.formData.details_stock?.is_assured;
      }
      return response;
    },
    get_patient_code() {
    ...
    get_price_patient() {
      ...
      if (
        ...
        if (this.form.bill_type === "hospitalization") {
          ...
          let price = 0;
          if (this.formData["type_consultation"]["code"].startsWith("TEC")) {
            price = this.formData["type_consultation"]
              ? this.formData["type_consultation"]["prices"].find(
                  (el) => el.speciality === this.form.doctor.type_doctor.title,
                  (el) => el.type_emergency === this.formData.type_emergency,
                  (el) => el.type_consult === this.formData.type_consult,
    ...
    get_patient_insurance() {
      ...
      patient_insurance =
        this.form.patient?.is_assured == true
          ? this.form.patient?.insurance_agency.insurance.percent
          : 0;
    ...
    get_pu_net() {
      if (
        ...
        let PUN = 0;
        PUN = pun / 100;
        if (this.formData.delivery_cash) {
          PUN = this.formData.delivery_cash;
        } else {
          PUN = 0;
        }
        let PUNT = 0;
    ...
    get_insurance_total() {
      ...
      if (this.get_patient_insurance === 0) {
        ...
        console.log(this.get_patient_insurance, total_net, total_insurance);
        let total = 0;
        if (total_net) {
          total =
