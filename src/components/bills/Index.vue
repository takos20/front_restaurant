  ...
  <div>
    ...
    <v-card>
      ...
      >
        ...
        <template v-slot:header.refund="{ header }">
          <tr>
            {{
              $vuetify.lang.t(header.text)
            }}
        ...
        <template v-slot:header.deleted="{ header }">
          <tr>
            {{
              $vuetify.lang.t(header.text)
            }}
...
import DeleteItem from "./../Common/DeleteBillValidate";
  ...
  methods: {
    ...
    setHeaders() {
      this.headers = [
        ...
        {
          text: "$vuetify.bills.cols.refund.title",
          value: "refund",
          align: "start",
          sortable: true,
          width: "6",
