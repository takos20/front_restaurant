  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_type_exam')"
          >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.type_exam.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
...
export default {
  ...
  methods: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.type_exam.new.title",
        submit: "$vuetify.type_exam.new.submit",
        success: "$vuetify.type_exam.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editType_exam(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.type_exam.update.title",
        submit: "$vuetify.type_exam.update.submit",
        success: "$vuetify.type_exam.update.success",
      };
