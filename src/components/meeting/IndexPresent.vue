          ...
          <v-hover>
            <tbody>
              <tr :key="elt.id" v-for="elt in items">
                ...
                <td class="subtitle-2">
                  {{
                    $moment(elt.meeting.created).format("YYYY-MM-DD HH:mm:ss")
                  }}
                </td>
              </tr>
            </tbody>
  ...
  methods: {
    ...
    getItems() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItems + "?meeting=" + this.form.id,
            params: params,
          })
          .then((response) => {
    ...
    setHeaders() {
      this.headers = [
        ...
        {
          text: "$vuetify.meeting.cols.external_guests.phone",
          value: "phone",
          align: "start",
          sortable: false,
          width: "15",
        ...
        {
          text: "$vuetify.meeting.cols.external_guests.email",
          value: "email",
          align: "start",
          sortable: false,
          width: "15",
        ...
        {
          text: "$vuetify.meeting.cols.external_guests.function",
          value: "function",
          align: "start",
          sortable: false,
          width: "15",
