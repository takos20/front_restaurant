              ...
              <v-row wrap>
                ...
                <v-col cols="12" sm="4" class="mb-0 py-0">
                  <v-select
                    ...
                    v-model="form.type"
                    color="primary"
                    :items="optionBonus.type_bonus"
                    :label="
                      $vuetify.lang.t(
                        '$vuetify.performanceBonus.cols.type.title'
                      )
                    "
                    :placeholder="
                      $vuetify.lang.t(
...
import { existNameBonus } from "../../helpers/Validator";
...
export default {
  ...
  methods: {
    getOptionsBonus() {
      ...
      let self = this;
      this._.each(this.$store.getters.type_bonus, (type_bonus) => {
        self.optionBonus.type_bonus.push({
          text: self.$vuetify.lang.t(type_bonus.text),
          value: type_bonus.value,
        });
      });
    },
