            ...
            <tbody slot-scope="{ hover }">
              ...
              <tr :key="item.id" v-for="item in items">
                ...
                <td class="subtitle-2">
                  {{
                    $vuetify.lang.t(
                      "$vuetify.performanceBonus.cols.type." + item.type
                    )
                  }}
                </td>
                <td class="subtitle-2">
...
export default {
  ...
  data: () => ({
    ...
    messagesDelete: {
      success: "$vuetify.performanceBonus.delete.success",
    },
  }),
  methods: {
    setHeaders() {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.performanceBonus.new.title",
        submit: "$vuetify.performanceBonus.new.submit",
        success: "$vuetify.performanceBonus.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editRadiography(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.performanceBonus.update.title",
        submit: "$vuetify.performanceBonus.update.submit",
        success: "$vuetify.performanceBonus.update.success",
      };
