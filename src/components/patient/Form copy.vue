                  ...
                  <v-row wrap>
                    ...
                    <v-col cols="12" sm="2" class="mb-0 py-0">
                      <v-btn
                        ...
                        max-width="2px"
                        v-if="
                          _.includes(this.$auth.user().permissions, 'add_city')
                        "
                      >
                    ...
                    <v-col
                      ...
                      sm="4"
                      class="mb-0 py-0"
                      v-if="this.form.is_assured == true"
                    >
                      <v-autocomplete
                        dense
                    ...
                    >
                      <v-text-field
                        v-model="form.primary_insured"
                        color="primary"
                        :label="
                          $vuetify.lang.t(
                            '$vuetify.patient.cols.primary_insured.title'
                          )
                        "
                        prepend-inner-icon="mdi-account mdi-dark mdi-18px"
                        class="font-weight-bold"
                    ...
                    >
                      <v-text-field
                        ...
                        :label="
                          $vuetify.lang.t(
                            '$vuetify.insurance.cols.number.title'
                          )
                        "
...
export default {
  ...
  data: () => ({
    ...
    itemsType_patient: [],
    urlType_insurance: "insurance_agencies/all",
  ...
  methods: {
    ...
    getDataForm() {
      let data = {
        ...
        insurance_agency: this.form.insurance,
    ...
    setForm(item) {
      ...
      this.form.insurance =
        item.insurance_agency == null
          ? item.insurance_agency
          : item.insurance_agency["id"];
      this.itemsType_insurance.push(item.insurance_agency);
    },
  },
  computed: {
    get_age() {
