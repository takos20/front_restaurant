  ...
  <v-card>
    <v-row>
      ...
      <v-col cols="12" sm="2">
        ...
        >
          {{
            $vuetify.lang.t("$vuetify.patients_settlements.cols.payment.title")
          }}
          ...
          <tbody>
            <tr :key="item.id" v-for="item in items">
              ...
              <td class="subtitle-2" v-if="item.payment_method === 'CASH'">
                {{
                  $vuetify.lang.t(
                    "$vuetify.bills.cols.payment_method." + item.payment_method
                  )
                }}
              </td>
              ...
              <td class="subtitle-2" v-else-if="item.payment_method === 'MOMO'">
                {{
                  $vuetify.lang.t(
                    "$vuetify.bills.cols.payment_method." + item.payment_method
                  )
              ...
              >
                {{
                  $vuetify.lang.t("$vuetify.bills.cols.payment_method.NO_PAY")
                }}
              </td>
...
import FormSettlements from "./../patients_settlements/Form";
