<template>
  <div>
    <v-card class="pb-4">
      <div class="mt-5 mx-5">
        <!-- <template
          v-if="_.includes(this.$auth.user().permissions, 'add_employeebonus')"
        >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.employeeBonus.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
    ...
    <v-card>
      ...
      >
        ...
        <template v-slot:header.bonus="{ header }">
          <tr>
            {{
              $vuetify.lang.t(header.text)
            }}
...
export default {
  ...
  methods: {
    setHeaders() {
      this.headers = [
        // {
        //   text: "$vuetify.employeeBonus.cols.code.title",
        //   value: "code",
        //   align: "start",
        //   sortable: true,
        //   width: "15",
        ...
        {
          text: "$vuetify.performanceBonus.title",
          value: "bonus",
          align: "start",
          sortable: true,
          width: "50",
        ...
        {
          text: "$vuetify.employeeBonus.cols.created.title",
          value: "created",
          align: "start",
          sortable: true,
          width: "105",
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.employeeBonus.new.title",
        submit: "$vuetify.employeeBonus.new.submit",
        success: "$vuetify.employeeBonus.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editDiscipline(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.employeeBonus.update.title",
        submit: "$vuetify.employeeBonus.update.submit",
        success: "$vuetify.employeeBonus.update.success",
      };
