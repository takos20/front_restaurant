    ...
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="
              _.includes(this.$auth.user().permissions, 'add_typeconsultation')
            "
          >
                      ...
                      <template
                        ...
                        v-if="
                          _.includes(
                            ...
                            'change_typeconsultation'
                          )
                        "
                      >
                        <v-btn
                          @click="editType_consultation(item)"
                          color="secondary"
                          icon
                          text
                          v-on="on"
...
export default {
  ...
  data: () => ({
    ...
    loadingImport: false,
    messagesDelete: {
      success: "$vuetify.type_consultation.delete.success",
    },
  }),
  methods: {
    upload() {
      ...
      axios
        .post("type_consultations/upload", formData, {
          headers: {
    ...
    setHeaders() {
      this.headers = [
        ...
        // },
        {
          text: "$vuetify.consultation.cols.consultation_type.title",
          value: "type",
          align: "start",
          sortable: true,
          width: "50",
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.type_consultation.new.title",
        submit: "$vuetify.type_consultation.new.submit",
        success: "$vuetify.type_consultation.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editType_consultation(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.type_consultation.update.title",
        submit: "$vuetify.type_consultation.update.submit",
        success: "$vuetify.type_consultation.update.success",
      };
      this.$refs.type_consultationForm.setForm(item);
    },
    performFilter() {
      let self = this;
