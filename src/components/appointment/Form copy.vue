            ...
            <v-row wrap>
              ...
              <v-col cols="12" sm="3" class="mb-0 py-0">
                <v-select
                  ...
                  :label="
                    $vuetify.lang.t(
                      '$vuetify.patient.cols.status_disease.title'
                    )
                  "
                ></v-select>
              </v-col>
              ...
              <v-col cols="12" sm="4" class="mb-0 py-0">
                <v-autocomplete
                  ...
                  item-value="id"
                  :label="
                    $vuetify.lang.t('$vuetify.appointment.cols.doctor.title')
                  "
                  class="font-weight-bold"
                  clearable
                  prefix="Dr"
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      ...
                      :label="
                        $vuetify.lang.t(
                          '$vuetify.appointment.cols.appointment_hour.title'
                        )
                      "
                      v-bind="attrs"
                      v-on="on"
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      ...
                      color="primary"
                      :label="
                        $vuetify.lang.t('$vuetify.appointment.cols.color.title')
                      "
                      class="font-weight-bold"
                      v-bind="attrs"
                      v-on="on"
...
export default {
  ...
  computed: {
    ...
    problemErrors() {
      ...
      !this.$v.form.patient.required &&
        errors.push(
          this.$vuetify.lang.t("$vuetify.appointment.cols.problem.required")
        );
      return errors;
    },
    appointment_statusErrors() {
      ...
      !this.$v.form.appointment_status.required &&
        errors.push(
          this.$vuetify.lang.t(
            "$vuetify.appointment.cols.appointment_status.required"
          )
        );
      return errors;
    },
