  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_checkup')"
          >
                  ...
                  <template>
                    <v-tooltip bottom>
                      <template
                        v-slot:activator="{ on }"
                        v-if="
                          _.includes($auth.user().permissions, 'change_checkup')
                        "
                      >
                        <v-btn
                          @click="editCheckup(item)"
                          color="secondary"
                          icon
                          text
                          v-on="on"
                    ...
                    <v-tooltip bottom>
                      <template
                        v-slot:activator="{ on }"
                        v-if="
                          _.includes($auth.user().permissions, 'delete_checkup')
                        "
                      >
                        <v-btn
...
export default {
  ...
  methods: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.checkup.new.title",
        submit: "$vuetify.checkup.new.submit",
        success: "$vuetify.checkup.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editCheckup(item) {
      ...
      this.$refs.checkupForm.setForm(item);
    },
    performFilter() {
      let self = this;
