<template>
  <div>
    ...
    <v-card class="pb-4">
      <div class="mt-5 mx-5">
        <template v-if="_.includes(this.$auth.user().permissions, 'add_bills')">
          ...
          <v-hover>
            <tbody slot-scope="{ hover }">
              <tr :key="item.id" v-for="item in items">
                ...
                <td class="subtitle-2">{{ Number(item.total_amount).toFixed(2) }}</td>
                <td class="subtitle-2">
...
export default {
  ...
  methods: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.recipe.new.title",
        submit: "$vuetify.recipe.new.submit",
        success: "$vuetify.recipe.new.success",
      };
      this.form = {
        id: null,
        dish: null,
    ...
    editBills(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.recipe.update.title",
        submit: "$vuetify.recipe.update.submit",
        success: "$vuetify.recipe.update.success",
      };
    ...
    performFilter() {
      ...
      if (self.filter.name_language !== null) {
        params["dish_name"] = self.filter.name_language;
      }
      self._search = params;
