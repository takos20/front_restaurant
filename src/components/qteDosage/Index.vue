<template>
  <div>
    <v-card class="pb-4">
      <div class="mt-5 mx-5">
        <template
          v-if="_.includes(this.$auth.user().permissions, 'add_qtedosage')"
        >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.qteDosage.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
          <v-col class="mb-0 py-0" cols="12" sm="6">
            <v-text-field
              :label="$vuetify.lang.t('$vuetify.qteDosage.cols.title.title')"
...
import FormQtedosage from "./Form";
...
export default {
  ...
  data: () => ({
    ...
    messagesDelete: {
      success: "$vuetify.qtedosages.delete.success",
    },
  }),
  methods: {
    setHeaders() {
      this.headers = [
        {
          text: "$vuetify.qteDosage.cols.title.title",
          value: "title",
          align: "start",
          sortable: true,
          width: "50",
    ...
    editQtedosage(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.qteDosage.update.title",
        submit: "$vuetify.qteDosage.update.submit",
        success: "$vuetify.qteDosage.update.success",
      };
      this.$refs.qtedosageForm.setForm(item);
    },
    performFilter() {
      let self = this;
