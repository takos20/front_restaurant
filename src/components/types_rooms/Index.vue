  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_types_rooms')"
          >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.types_rooms.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
...
export default {
  ...
  data: () => ({
    ...
    messagesDelete: {
      success: "$vuetify.types_rooms.delete.success",
    },
  }),
  methods: {
    upload() {
      ...
      axios
        .post("type_exams/upload", formData, {
          headers: {
    ...
    setHeaders() {
      this.headers = [
        {
          text: "$vuetify.types_rooms.cols.title.title",
          value: "title",
          align: "start",
          sortable: true,
          width: "50",
        ...
        {
          text: "$vuetify.types_rooms.cols.created.title",
          value: "create_date",
          align: "start",
          sortable: true,
          width: "105",
        ...
        {
          text: "$vuetify.types_rooms.cols.actions.title",
          value: null,
          align: "start",
          sortable: true,
          width: "40",
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.types_rooms.new.title",
        submit: "$vuetify.types_rooms.new.submit",
        success: "$vuetify.types_rooms.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editTypes_rooms(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.types_rooms.update.title",
        submit: "$vuetify.types_rooms.update.submit",
        success: "$vuetify.types_rooms.update.success",
      };
      this.$refs.types_roomsForm.setForm(item);
    },
    performFilter() {
      let self = this;
