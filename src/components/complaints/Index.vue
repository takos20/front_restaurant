<template>
  <div>
    <v-card class="pb-4">
      <div class="mt-5 mx-5">
        <template
          v-if="_.includes(this.$auth.user().permissions, 'add_complaints')"
        >
    ...
    <v-card>
      ...
      >
        ...
        <template v-slot:header.delivery_person="{ header }">
          <tr>
            {{
              $vuetify.lang.t(header.text)
            }}
        ...
        <template v-slot:header.witnesses="{ header }">
          <tr>
            {{
              $vuetify.lang.t(header.text)
            }}
                  ...
                  <v-tooltip top>
                    ...
                    <template>
                      <span v-if="item.is_accounted === false">
                        {{
                          $vuetify.lang.t(
                            "$vuetify.supplies.cols.is_accounted.title"
                          )
                        }}
                      </span>
                      <span v-else>
  ...
  methods: {
    ...
    setHeaders() {
      this.headers = [
        ...
        // {
        //   text: "$vuetify.supplies.cols.is_received.title",
        //   value: "is_received",
        //   align: "start",
        //   sortable: true,
        //   width: "6",
