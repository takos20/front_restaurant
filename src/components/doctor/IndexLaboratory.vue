    ...
    <v-row wrap>
      <v-col cols="12" sm="4" class="mb-0 py-0">
        <h3 style="padding-left: 15px" class="my-4">
          {{
            $vuetify.lang.t("$vuetify.permission.cols.model.laboratorypatient")
          }}
        </h3>
      </v-col>
      <v-col cols="12" sm="4" class="mb-0 py-0">
        ...
        >
          <template v-slot:activator="{ on, attrs }">
            <v-text-field
              v-model="form.start_date_laboratory"
              color="primary"
      ...
      <v-col cols="12" sm="4" class="mb-0 py-0">
        ...
        >
          <template v-slot:activator="{ on, attrs }">
            <v-text-field
              v-model="form.end_date_laboratory"
              color="primary"
              class="font-weight-bold my-2"
              ...
              <td class="subtitle-2">
                <template>
                  ...
                  <v-tooltip bottom>
                    ...
                    <span>{{ $vuetify.lang.t("$vuetify.btn.download") }}</span>
                  </v-tooltip>
                </template>
              </td>
            </tr>
...
import FormLaboratory from "./../laboratory_patient/Formbills";
...
export default {
  ...
  data: () => ({
    ...
    form: {
      ...
      medication: null,
      patient: null,
      start_date_laboratory: null,
      end_date_laboratory: null,
      consultation: null,
    },
    filter: {
      userpatient: null,
  ...
  computed: {
    getminDatePatient() {
      let minDateBestSell = "";
      minDateBestSell = new Date(this.form.start_date_laboratory)
        ?.toISOString()
        .substr(0, 10);
  ...
  methods: {
    ...
    getItems() {
      ...
      if (self.form.start_date_laboratory !== null) {
        params["start_date_laboratory"] = self.form.start_date_laboratory;
      }
      if (self.form.end_date_laboratory !== null) {
        params["end_date_laboratory"] = self.form.end_date_laboratory;
      }
