              ...
              <v-row wrap>
                ...
                <v-col cols="12" sm="6" class="mb-0 py-0">
                  <v-text-field
                    ...
                    "
                    @blur="$v.form.quantity_min.$touch()"
                    @input="$v.form.quantity_min.$touch()"
                    :error-messages="quantity_minErrors"
                ...
                <v-col cols="12" sm="6" class="mb-0 py-0">
                  <v-text-field
                    ...
                    "
                    @blur="$v.form.quantity_max.$touch()"
                    @input="$v.form.quantity_max.$touch()"
                    :error-messages="quantity_maxErrors"
                    prepend-inner-icon="mdi-numeric mdi-dark mdi-18px"
                    class="font-weight-bold"
                    outlined
                    dense
                ...
                <v-col cols="12" sm="6" class="mb-0 py-0">
                  <v-text-field
                    ...
                    "
                    @blur="$v.form.purchase_price.$touch()"
                    @input="$v.form.purchase_price.$touch()"
                    :error-messages="purchase_priceErrors"
                    class="font-weight-bold"
                ...
                <v-col cols="12" sm="6" class="mb-0 py-0">
                  <v-text-field
                    ...
                    "
                    @blur="$v.form.public_price.$touch()"
                    @input="$v.form.public_price.$touch()"
                    :error-messages="public_priceErrors"
                    class="font-weight-bold"
                    prepend-inner-icon="mdi-credit-card-plus mdi-dark mdi-18px"
                    outlined
                    dense
