  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_district')"
          >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.district.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
...
export default {
  ...
  methods: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.district.new.title",
        submit: "$vuetify.district.new.submit",
        success: "$vuetify.district.new.success",
      };
      this.form = {
        id: null,
        code: null,
    ...
    editCategory(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.district.update.title",
    ...
    performFilter() {
      ...
      if (self.filter.is_default !== null) {
        params["is_default"] = self.filter.is_default;
      }
      if (self.filter.city !== null) {
        params["city"] = self.filter.city;
      }
      self._search = params;
