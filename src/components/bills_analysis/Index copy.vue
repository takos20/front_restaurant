  ...
  <div>
          ...
          <v-form>
            <v-row wrap>
              ...
              <v-chip
                ...
                label
              >
                {{ $vuetify.lang.t("$vuetify.bills.titlePaid") }}
                : {{ Intl.NumberFormat().format(this.sum_paid) }}
                <!--{{ sum_zero| numberformat(locale, 0, "currency", "XAF")  }}-->
              </v-chip>
              <v-chip
                class="subtitle-1 font-weight-bold my-6"
                ...
                label
              >
                {{ $vuetify.lang.t("$vuetify.bills.titleUnpaid") }}
                : {{ Intl.NumberFormat().format(this.sum_unpaid) }}
                <!--{{ sum_zero| numberformat(locale, 0, "currency", "XAF")  }}-->
              </v-chip>
              <!--              <v-chip-->
              <!--                class="subtitle-1 font-weight-bold my-6 "-->
    ...
    <v-card class="pb-4">
      ...
      <v-card-actions style="margin-top: -20px">
        ...
        <v-btn depressed color="#FF9E80" @click="bills((typeBills = 'unpaid'))">
        ...
        <v-row wrap>
          ...
          <v-col class="mb-0 py-0" cols="12" sm="4">
            <v-autocomplete
              ...
              color="primary"
              return-object
              :disabled="!this.filter.start_date || !this.filter.end_date"
              item-text="username"
              @change="performFilter"
              item-value="id"
