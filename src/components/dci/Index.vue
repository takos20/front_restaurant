<template>
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template v-if="_.includes(this.$auth.user().permissions, 'add_dci')">
                  ...
                  <template>
                    <v-tooltip bottom>
                      <template
                        v-slot:activator="{ on }"
                        v-if="
                          _.includes($auth.user().permissions, 'change_dci')
                        "
                      >
                        <v-btn
                          @click="editdci(item)"
                    ...
                    <v-tooltip bottom>
                      <template
                        v-slot:activator="{ on }"
                        v-if="
                          _.includes($auth.user().permissions, 'delete_dci')
                        "
                      >
                        <v-btn
...
export default {
  ...
  data: () => ({
    ...
    loadingImport: false,
    messagesDelete: {
      success: "$vuetify.dci.delete.success",
    },
  }),
  methods: {
    upload() {
    ...
    setHeaders() {
      this.headers = [
        ...
        {
          text: "$vuetify.dci.cols.name.title",
          value: "name",
          align: "start",
          sortable: true,
          width: "15",
        ...
        {
          text: "$vuetify.dci.cols.created.title",
          value: "create_date",
          align: "start",
          sortable: true,
          width: "105",
        ...
        {
          text: "$vuetify.dci.cols.actions.title",
          value: null,
          align: "start",
          sortable: true,
          width: "40",
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.dci.new.title",
        submit: "$vuetify.dci.new.submit",
        success: "$vuetify.dci.new.success",
      };
      this.form = {
        id: null,
        code: null,
    ...
    editdci(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.dci.update.title",
