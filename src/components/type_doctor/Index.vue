<template>
  <div>
    <v-card class="pb-4">
      <div class="mt-5 mx-5">
        <template
          v-if="_.includes(this.$auth.user().permissions, 'add_type_doctor')"
        >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.type_doctor.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
...
export default {
  ...
  data: () => ({
    ...
    messagesDelete: {
      success: "$vuetify.type_doctor.delete.success",
    },
  }),
  methods: {
    setHeaders() {
      this.headers = [
        ...
        {
          text: "$vuetify.type_doctor.cols.share.title",
          value: "share",
          align: "start",
          sortable: true,
          width: "50",
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.type_doctor.new.title",
        submit: "$vuetify.type_doctor.new.submit",
        success: "$vuetify.type_doctor.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editType_exam(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.type_doctor.update.title",
        submit: "$vuetify.type_doctor.update.submit",
        success: "$vuetify.type_doctor.update.success",
      };
