<template>
  <div v-if="_.includes($auth.user().permissions, 'view_dashboard_diagnostic')">
    <br />
    <!--    <v-btn-->
    ...
    <!--    </v-btn>-->
    <v-card height="50px" flat color="primary">
      <v-card-text>
        <v-row wrap>
  ...
  methods: {
    ...
    getItems() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsStat_day_month + "?type=diagnostic",
          })
          .then((response) => {
    ...
    sell_month_day() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsDays + "?type=diagnostic",
            method: self.getMethod(),
            data: self.getDataForm(),
          })
          .then((response) => {
