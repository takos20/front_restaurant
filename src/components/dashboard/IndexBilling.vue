        ...
        <v-row>
          <v-col lg="3" cols="6">
            <v-hover v-slot="{ hover }" open-delay="200">
              <v-card color="primary" :elevation="hover ? 16 : 2">
                <v-card-text
                  class="d-flex justify-space-between text-h6 align-center white--text"
                >
                  <div>
                    <strong>{{
          ...
          <v-col lg="3" cols="6">
            <v-hover v-slot="{ hover }" open-delay="200">
              <v-card color="primary" :elevation="hover ? 16 : 2">
                <v-card-text
                  class="d-flex justify-space-between align-center text-h6 white--text"
                >
                  <div>
                    <strong>{{
                ...
                <v-hover>
                  <tbody>
                    <tr :key="item.id" v-for="item in items">
                      ...
                      <td class="subtitle-2">
                        {{ parseFloat(item.cost_production).toFixed(2) }}
                      </td>
        ...
        self.$store
          ...
          .then((response) => {
            ...
            for (const prop of data.content) {
              this.labels.push(
                prop.dish__category__name_language?.[0]?.name || ""
              );
