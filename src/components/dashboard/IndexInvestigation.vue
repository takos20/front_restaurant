<template>
  <div
    v-if="_.includes($auth.user().permissions, 'view_dashboard_investigation')"
  >
    <br />
    <!--    <v-btn-->
  ...
  methods: {
    ...
    getItems() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsStat_day_month + "?type=investigation",
          })
          .then((response) => {
    ...
    sell_month_day() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsDays + "?type=investigation",
            method: self.getMethod(),
            data: self.getDataForm(),
          })
          .then((response) => {
