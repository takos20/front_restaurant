<template>
  <div
    v-if="_.includes($auth.user().permissions, 'view_dashboard_radiography')"
  >
    <br />
    <!--    <v-btn-->
  ...
  methods: {
    ...
    getItems() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsStat_day_month + "?type=radiography",
          })
          .then((response) => {
    ...
    sell_month_day() {
      ...
      return new Promise((resolve, reject) => {
        ...
        self.$store
          .dispatch("request", {
            url: self.urlItemsDays + "?type=radiography",
            method: self.getMethod(),
            data: self.getDataForm(),
          })
          .then((response) => {
