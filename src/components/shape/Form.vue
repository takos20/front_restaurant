              ...
              <v-row wrap>
                <v-col cols="12" sm="4" class="mb-0 py-0">
                  <v-text-field
                    v-model="form.code"
                    color="primary"
                    :label="$vuetify.lang.t('$vuetify.shape.cols.code.title')"
                ...
                >
                  <v-switch
                    ...
                    color="primary"
                    :label="
                      $vuetify.lang.t('$vuetify.shape.cols.status.title2')
                    "
                    outlined
                    dense
                  ></v-switch>
                ...
                <v-col cols="12" sm="12" class="mb-0 py-0">
                  <v-text-field
                    v-model="form.name"
                    color="primary"
                    :label="$vuetify.lang.t('$vuetify.shape.cols.name.title')"
...
import { existNameshape } from "../../helpers/Validator";
  ...
  computed: {
    ...
    nameErrors() {
      ...
      !this.$v.form.name.required &&
        errors.push(this.$vuetify.lang.t("$vuetify.shape.cols.name.required"));

      !this.$v.form.name.minLength &&
        errors.push(
          this.$vuetify.lang.t(
            "$vuetify.shape.cols.name.minLength",
            this.$v.form.name.$params.minLength.min
          )
        );

      !this.$v.form.name.unique &&
        errors.push(this.$vuetify.lang.t("$vuetify.shape.cols.name.unique"));
      return errors;
    },
    codeErrors() {
      let errors = [];
      ...
      !this.$v.form.code.required &&
        errors.push(this.$vuetify.lang.t("$vuetify.shape.cols.code.required"));

      !this.$v.form.code.maxLength &&
        errors.push(
          this.$vuetify.lang.t(
            "$vuetify.shape.cols.code.maxLength",
    ...
    billableErrors() {
      ...
      !this.$v.form.billable.required &&
        errors.push(
          this.$vuetify.lang.t("$vuetify.shape.cols.billable.required")
        );

      !this.$v.form.billable.maxLength &&
        errors.push(
          this.$vuetify.lang.t(
            "$vuetify.shape.cols.billable.maxLength",
