<template>
  <div>
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.function_exploration.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
          <v-col class="mb-0 py-0" cols="12" sm="12">
            <v-text-field
              :label="
                $vuetify.lang.t(
                  '$vuetify.function_exploration.cols.title.title'
                )
              "
...
export default {
  mixins: [ListMixin],
  data: () => ({
    urlItems: "/functional_explorations",
    sortBy: ["id"],
    dialogForm: {
      show: false,
      shows: {
    ...
    messagesDelete: {
      success: "$vuetify.function_exploration.delete.success",
    },
  }),
  methods: {
    upload() {
      ...
      axios
        .post("functional_explorations/upload", formData, {
          headers: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.functional_exploration.new.title",
        submit: "$vuetify.functional_exploration.new.submit",
        success: "$vuetify.functional_exploration.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editRadiography(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.functional_exploration.update.title",
        submit: "$vuetify.functional_exploration.update.submit",
        success: "$vuetify.functional_exploration.update.success",
      };
