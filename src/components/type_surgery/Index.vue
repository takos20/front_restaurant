  ...
  <div>
    <v-card class="pb-4">
      <v-row wrap>
        <div class="mt-5 mx-5">
          <template
            v-if="_.includes(this.$auth.user().permissions, 'add_type_surgery')"
          >
    ...
    <v-card class="pb-4">
      <v-card-title>
        <div class="title">
          {{ $vuetify.lang.t("$vuetify.type_surgery.filter") }}
        </div>
      </v-card-title>
      <v-card-text>
        <v-row wrap>
...
export default {
  ...
  methods: {
    upload() {
      ...
      axios
        .post("type_surgeries/upload", formData, {
          headers: {
    ...
    create() {
      ...
      this.messages = {
        title: "$vuetify.type_surgery.new.title",
        submit: "$vuetify.type_surgery.new.submit",
        success: "$vuetify.type_surgery.new.success",
      };
      this.form = {
        id: null,
        title: null,
    ...
    editType_exam(item) {
      this.dialogForm.show = true;
      this.messages = {
        title: "$vuetify.type_surgery.update.title",
        submit: "$vuetify.type_surgery.update.submit",
        success: "$vuetify.type_surgery.update.success",
      };
